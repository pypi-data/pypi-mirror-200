...
from utils.RegexUtils import XsRegexUtils
...
class XsStringVal:
    ...
    def is_integer(input_string: str) -> bool:
        ...
        """
        return XsStringVal.is_number(input_string) and '.' not in input_string
    ...
    def is_decimal(input_string: str) -> bool:
        ...
        :return: True if integer, false otherwise
        """
        return XsStringVal.is_number(input_string) and '.' in input_string
