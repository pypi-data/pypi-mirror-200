from terminalpackagehamderber.src import terminal_settings as settings, command_handler
...
def main():
    ...
    while True:
        ...
        # that is being used to connect to the MySQL database. Ex: command line showing 'admin>'
