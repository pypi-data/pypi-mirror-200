...
class CfnAppMonitor(
    ...
    def __init__(
        ...
        *,
        ...
        custom_events: typing.Optional[typing.Union[typing.Union["CfnAppMonitor.CustomEventsProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
    ...
    def custom_events(
        self,
    ) -> typing.Optional[typing.Union["CfnAppMonitor.CustomEventsProperty", _IResolvable_da3f097b]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnAppMonitor.CustomEventsProperty", _IResolvable_da3f097b]], jsii.get(self, "customEvents"))

    @custom_events.setter
    def custom_events(
        self,
        value: typing.Optional[typing.Union["CfnAppMonitor.CustomEventsProperty", _IResolvable_da3f097b]],
    ) -> None:
        if __debug__:
...
class CfnAppMonitorProps:
    ...
    def custom_events(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnAppMonitor.CustomEventsProperty, _IResolvable_da3f097b]], result)
