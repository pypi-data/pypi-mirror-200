...
class DBNode(DBItem):
    ...
    def get_properties(self):
        ...
        for name, data in ndata["properties"].items():
            prop = DBProperty(node_uuid=self.uuid, name=name)  # , self.daemon_name)
    ...
    def get_inputs(self):
        ...
        for data in ndata["inputs"]:
            socket = DBSocket(type="input", dbdata=data)  # , self.daemon_name)
    ...
    def get_outputs(self):
        ...
        for data in ndata["outputs"]:
            socket = DBSocket(type="output", dbdata=data)  # , self.daemon_name)
