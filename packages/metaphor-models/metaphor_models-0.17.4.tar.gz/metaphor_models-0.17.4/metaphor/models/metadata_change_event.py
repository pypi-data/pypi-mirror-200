...
class GetStartedStepCompletion(Enum):
...
class OnboardingExperience:
    get_started_step_completions: Optional[List[GetStartedStepCompletion]] = None
    has_dismissed_get_started_steps: Optional[bool] = None

    @staticmethod
    def from_dict(obj: Any) -> 'OnboardingExperience':
        assert isinstance(obj, dict)
        get_started_step_completions = from_union([lambda x: from_list(GetStartedStepCompletion, x), from_none], obj.get("getStartedStepCompletions"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["getStartedStepCompletions"] = from_union([lambda x: from_list(lambda x: to_enum(GetStartedStepCompletion, x), x), from_none], self.get_started_step_completions)
