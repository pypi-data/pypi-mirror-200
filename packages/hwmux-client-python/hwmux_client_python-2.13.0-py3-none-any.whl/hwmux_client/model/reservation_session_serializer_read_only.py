...
class ReservationSessionSerializerReadOnly(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, owner, is_satisfied, response_message, status, queue_position, resource_data, details, t_requested, t_satisfied, t_completed, t_lease_expires, metadata, r_devices, r_device_groups, r_device_group_labels, a_devices, a_device_groups, *args, **kwargs):  # noqa: E501
