...
TreeSAK SliceMSA -i 16S.aln -fi fasta -s 200-300 -o SliceMSA_op
TreeSAK SliceMSA -i 16S.aln -fi phylip-relaxed -s sections.txt -o SliceMSA_op
...
if __name__ == '__main__':
    ...
    SliceMSA_parser.add_argument('-fi',  required=False, default='fasta',       help='format of MSA (this is not file extension), default: fasta')
