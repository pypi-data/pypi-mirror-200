...
def CompareMCMC(args):
    ...
    plt.xlabel(x_basename)
    plt.ylabel(y_basename)
    plt.tight_layout()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-lx',      required=True,   help='label for x axis')
    parser.add_argument('-ly',      required=True,   help='label for y axis')
