# python build stubs for package photogrammetry
...
mod = Module('_photogrammetry')
mod.add_include('"photogrammetry_go.h"')
...
add_checked_function(mod, 'photogrammetry_MonopoleCenterPoint', retval('int64_t'), [param('int64_t', 'mesh')])
add_checked_function(mod, 'photogrammetry_ShowNested', None, [param('int64_t', 's'), param('bool', 'goRun')])
add_checked_function(mod, 'photogrammetry_Arange', retval('int64_t'), [param('double', 'start'), param('double', 'stop'), param('double', 'step')])
add_checked_function(mod, 'photogrammetry_CalculateDeviation', retval('double'), [param('int64_t', 'xPoint'), param('int64_t', 'zPoint'), param('int64_t', 'centerPoint'), param('double', 'radius')])
add_checked_function(mod, 'photogrammetry_CoordinateToAzimuth', retval('double'), [param('int64_t', 'coordinate')])
add_checked_function(mod, 'photogrammetry_ElementInRange', retval('int64_t'), [param('int64_t', 'coordinates'), param('int64_t', 'dimension'), param('double', 'start'), param('double', 'stop')])
add_checked_function(mod, 'photogrammetry_IsUniformQuadrant', retval('bool'), [param('int64_t', 'xPoint'), param('int64_t', 'zPoint'), param('int64_t', 'centerPoint')])
add_checked_function(mod, 'photogrammetry_LatticeCenterPoint', retval('int64_t'), [param('int64_t', 'mesh')])

mod.generate(open('photogrammetry.c', 'w'))
