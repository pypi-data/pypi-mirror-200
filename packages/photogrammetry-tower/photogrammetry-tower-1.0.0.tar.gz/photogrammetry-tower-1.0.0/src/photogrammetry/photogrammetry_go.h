...
/* package photogrammetry/lib_photogrammetry */
...
extern long long int photogrammetry_MonopoleCenterPoint(long long int mesh);
extern void photogrammetry_ShowNested(long long int s, char goRun);
extern long long int photogrammetry_Arange(double start, double stop, double step);
extern double photogrammetry_CalculateDeviation(long long int xPoint, long long int zPoint, long long int centerPoint, double radius);
extern double photogrammetry_CoordinateToAzimuth(long long int coordinate);
extern long long int photogrammetry_ElementInRange(long long int coordinates, long long int dimension, double start, double stop);
extern char photogrammetry_IsUniformQuadrant(long long int xPoint, long long int zPoint, long long int centerPoint);
extern long long int photogrammetry_LatticeCenterPoint(long long int mesh);
