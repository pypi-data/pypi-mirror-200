/*
cgo stubs for package photogrammetry.
...
// --- generated code for package: photogrammetry below: ---
...
//export photogrammetry_MonopoleCenterPoint
func photogrammetry_MonopoleCenterPoint(mesh CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := photogrammetry.MonopoleCenterPoint(deptrFromHandle_Slice_Slice_float64(mesh))

	return handleFromPtr_Slice_float64(&cret)
}

//export photogrammetry_ShowNested
func photogrammetry_ShowNested(s CGoHandle, goRun C.char) {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	if boolPyToGo(goRun) {
		go photogrammetry.ShowNested(deptrFromHandle_Slice_Slice_float64(s))
	} else {
		photogrammetry.ShowNested(deptrFromHandle_Slice_Slice_float64(s))
	}
}

//export photogrammetry_Arange
func photogrammetry_Arange(start C.double, stop C.double, step C.double) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := photogrammetry.Arange(float64(start), float64(stop), float64(step))

	return handleFromPtr_Slice_float64(&cret)
}

//export photogrammetry_CalculateDeviation
func photogrammetry_CalculateDeviation(xPoint CGoHandle, zPoint CGoHandle, centerPoint CGoHandle, radius C.double) C.double {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	return C.double(photogrammetry.CalculateDeviation(deptrFromHandle_Slice_float64(xPoint), deptrFromHandle_Slice_float64(zPoint), deptrFromHandle_Slice_float64(centerPoint), float64(radius)))

}

//export photogrammetry_CoordinateToAzimuth
func photogrammetry_CoordinateToAzimuth(coordinate CGoHandle) C.double {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	return C.double(photogrammetry.CoordinateToAzimuth(deptrFromHandle_Slice_float64(coordinate)))

}

//export photogrammetry_ElementInRange
func photogrammetry_ElementInRange(coordinates CGoHandle, dimension C.longlong, start C.double, stop C.double) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := photogrammetry.ElementInRange(deptrFromHandle_Slice_Slice_float64(coordinates), int(dimension), float64(start), float64(stop))

	return handleFromPtr_Slice_Slice_float64(&cret)
}

//export photogrammetry_IsUniformQuadrant
func photogrammetry_IsUniformQuadrant(xPoint CGoHandle, zPoint CGoHandle, centerPoint CGoHandle) C.char {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	return boolGoToPy(photogrammetry.IsUniformQuadrant(deptrFromHandle_Slice_float64(xPoint), deptrFromHandle_Slice_float64(zPoint), deptrFromHandle_Slice_float64(centerPoint)))

}

//export photogrammetry_LatticeCenterPoint
func photogrammetry_LatticeCenterPoint(mesh CGoHandle) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	cret := photogrammetry.LatticeCenterPoint(deptrFromHandle_Slice_Slice_float64(mesh))
