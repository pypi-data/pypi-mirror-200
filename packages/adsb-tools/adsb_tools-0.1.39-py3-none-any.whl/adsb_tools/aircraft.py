    ...
    def add_aircraft_options(self):
        ...
        for aircraft in self.aircraft_list:
            ...
            if Aircraft.get_has_coordinates(aircraft):
                ...
                distances = spacial_utils.calculate_distances(
                    self.base_latitude, self.base_longitude, aircraft_lat, aircraft_lon
                )
                degrees = spacial_utils.get_degrees(
                    self.base_latitude, self.base_longitude, aircraft_lat, aircraft_lon
                )
                direction = spacial_utils.get_cardinal_direction(degrees)
                ...
                if ('track' in aircraft and isinstance(aircraft['track'], numbers.Number)):
                    movement = {
                        ...
                        'direction': spacial_utils.get_cardinal_direction(aircraft['track'])
                    }
