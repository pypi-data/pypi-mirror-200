...
def run_download(dir_path, limit=None, only_stock=False, only_brand=False, only_statments=False, only_yahoo=False) -> None:
...
class DailyStockCrawler:
    ...
    def list_target_date(self) -> List[datetime.date]:
        ...
        date_ls = workday_list(start_date, end_date)
