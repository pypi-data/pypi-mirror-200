...
To use Tetun LID, from the `tetunlid` package, import the `lid` module as follows:

1. In case you want to predict a sentence as the input text, use the `predict_language()` function.
