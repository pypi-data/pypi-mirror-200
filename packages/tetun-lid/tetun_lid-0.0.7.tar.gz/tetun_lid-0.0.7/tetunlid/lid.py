...
def predict_detail(input: List[str]) -> List[str]:
    ...
    for i, probs in enumerate(pred_probs):
        ...
        result += f'Our language model identified that the input text is "{max_lang_name.upper()}", with a confidence level of {max_prob * 100:.2f}%.\n\n'
