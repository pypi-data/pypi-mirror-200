...
class ConversionTest(BaseTestCase):
    def test_Times_HasCorrectSeconds(self):
        self.assertEqual(sw.Enums.TimeEnum.Day.value    * 2, 172800)
        self.assertEqual(sw.Enums.TimeEnum.Hour.value   * 2, 7200)
        self.assertEqual(sw.Enums.TimeEnum.Minute.value * 2, 120)
