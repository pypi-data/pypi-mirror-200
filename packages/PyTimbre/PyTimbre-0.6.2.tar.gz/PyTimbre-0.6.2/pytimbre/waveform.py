...
class Waveform:
    ...
    def trim(self, s0: float = 0.0, s1: float = None, method: trimming_methods = trimming_methods.samples):
        ...
        elif method == trimming_methods.times_absolute:
            t0 = s0
            t1 = s1
        ...
        elif method == trimming_methods.times_relative:
            t0 = s0
            t1 = s1
    ...
    def overall_level(self, integration_time: float = None,
        ...
        for i in range(n):
            subset = wfm.trim(t0, t0 + integration_time, trimming_methods.times_absolute)
