...
class Waveform:
    ...
    def fundamental_frequency(self):
        pyin_f0 = np.mean(libf0.pyin(self.samples,
                                     self.sample_rate,
                                     int(np.floor(self.sample_rate / 10)),
                                     F_min=10,
                                     F_max=10000)[0])
        yin_f0 = np.mean(libf0.yin(self.samples, self.sample_rate, int(np.floor(self.sample_rate / 10)), F_min=10,
                                   F_max=10000)[0])
        swipe_f0 = np.mean(libf0.swipe(self.samples, self.sample_rate, F_min=10, F_max=10000)[0])
        swipe_slim_f0 = np.mean(libf0.swipe_slim(self.samples, self.sample_rate, F_min=10, F_max=10000)[0])

        return [pyin_f0, yin_f0, swipe_f0, swipe_slim_f0]
