...
from kilroy_face_debug import log
from kilroy_face_debug.config import Config, get_config
from kilroy_face_debug.face import DebugFace
...
async def load_or_init(face: DebugFace, state_dir: Path) -> None:
...
async def run(config: Config) -> None:
    ...
    face_cls = DebugFace.for_category(face_type)
...
def main(
    ...
    """Command line interface for kilroy-face-debug."""
