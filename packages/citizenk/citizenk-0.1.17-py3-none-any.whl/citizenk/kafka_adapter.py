...
class KafkaAdapter:
    ...
    def get_all_broker_groups(self):
    ...
    def get_group_members(self, groups: Optional[List[str]] = None):
        connection = AdminClient(self.admin_config)
        if groups is None:
    ...
    def get_partition_id(self, topic: str, key: Union[str, bytes]):
    ...
    def get_all_broker_topics(self):
        """Get list of all topics in the broker"""
    ...
    def get_all_broker_partitions(self):
    ...
    def delete_offset_for_group(self, group: str, topic: Optional[str] = None):
        """
    ...
    def delete_old_offsets_for_group(self):
        if self.role != KafkaRole.CONSUMER:
            return 0
    ...
    def produce(
        self, topic: str, value: Any, key: Optional[Any] = None, partition: int = -1
    ):
