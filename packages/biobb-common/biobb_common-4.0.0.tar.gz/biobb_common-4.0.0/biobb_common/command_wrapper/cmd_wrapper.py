...
class CmdWrapper:
    ...
    def __init__(self, cmd: typing.Iterable[str], shell_path: typing.Union[str, Path] = os.getenv('SHELL', '/bin/sh'), out_log: logging.Logger = None, err_log: logging.Logger = None,
