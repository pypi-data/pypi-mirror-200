...
from pglift import db, instances, postgresql, roles, systemd
...
from . import AuthType, config_dict, passfile_entries, role_in_pgpass
...
def test_get_locale(ctx: Context, reconfigured: system.Instance) -> None:
    with db.connect(ctx, reconfigured) as conn:
