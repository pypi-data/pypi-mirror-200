...
def test_apply(
    ...
    database = interface.Database(
        ...
        extensions=[{"name": "hstore", "schema": "public"}],
...
def test_alter(
    ...
    execute(ctx, instance, "CREATE SCHEMA second_schema", fetch=False, dbname="alterme")
    execute(
        ctx,
        instance,
        "CREATE EXTENSION unaccent WITH SCHEMA my_schema",
    ...
    assert databases.get(ctx, instance, "alterme") == database.copy(
        update={
            ...
            "schemas": [
                interface.Schema(name="my_schema"),
                interface.Schema(name="public"),
                interface.Schema(name="second_schema"),
            ],
    ...
    database = interface.Database(
        ...
        schemas=[{"name": "second_schema", "state": "absent"}],
        extensions=[
    ...
    database = interface.Database(
        ...
        settings={},
        extensions=[
            {"name": "pg_stat_statements", "schema": "my_schema", "state": "absent"},
            {"name": "unaccent", "state": "absent", "schema": "public"},
        ],
    )
    databases.alter(ctx, instance, database)
    assert databases.get(ctx, instance, "alterme") == database.copy(
