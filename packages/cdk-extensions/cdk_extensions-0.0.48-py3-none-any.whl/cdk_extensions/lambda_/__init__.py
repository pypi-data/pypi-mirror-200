...
class ExecutionLogOptions:
    def __init__(
        ...
        *,
        ...
        level: aws_cdk.aws_stepfunctions.LogLevel,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ExecutionLogOptions.__init__)
    ...
    @builtins.property
    def level(self) -> aws_cdk.aws_stepfunctions.LogLevel:
        ...
        return typing.cast(aws_cdk.aws_stepfunctions.LogLevel, result)
...
class LogRetentionController(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        execution_logging: typing.Optional[typing.Union[ExecutionLogOptions, typing.Dict[str, typing.Any]]] = None,
        retention: typing.Optional[aws_cdk.aws_logs.RetentionDays] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LogRetentionController.__init__)
    ...
    def log_group_created_rule(self) -> aws_cdk.aws_events.Rule:
        '''The EventBridge rule that detects the creation of new log groups with a name matching the prefix used by AWS Lambda.

        :group: Resources
        '''
        return typing.cast(aws_cdk.aws_events.Rule, jsii.get(self, "logGroupCreatedRule"))
    ...
    def execution_log_group(self) -> typing.Optional[aws_cdk.aws_logs.ILogGroup]:
        '''The log group which will receive execution events from the state machine.

        :group: Resources
        '''
        return typing.cast(typing.Optional[aws_cdk.aws_logs.ILogGroup], jsii.get(self, "executionLogGroup"))
...
class LogRetentionControllerProps(aws_cdk.ResourceProps):
    def __init__(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(LogRetentionControllerProps.__init__)
