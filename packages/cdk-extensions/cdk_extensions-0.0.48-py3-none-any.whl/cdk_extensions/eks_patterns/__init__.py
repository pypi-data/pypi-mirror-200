...
class AwsIntegratedFargateCluster(
    ...
    def __init__(
        ...
        *,
        ...
        prometheus_options: typing.Optional[typing.Union["ClusterPrometheusOptions", typing.Dict[str, typing.Any]]] = None,
        ...
        awscli_layer: typing.Optional[aws_cdk.aws_lambda.ILayerVersion] = None,
...
class AwsIntegratedFargateClusterProps(aws_cdk.aws_eks.FargateClusterProps):
    ...
    @builtins.property
    def awscli_layer(self) -> typing.Optional[aws_cdk.aws_lambda.ILayerVersion]:
...
class ClusterPrometheusOptions(_PrometheusOptions_9119614c):
    def __init__(
        ...
        *,
        namespace: typing.Optional[builtins.str] = None,
        queue_configuration: typing.Optional[typing.Union[_QueueConfiguration_80ad1432, typing.Dict[str, typing.Any]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ClusterPrometheusOptions.__init__)
