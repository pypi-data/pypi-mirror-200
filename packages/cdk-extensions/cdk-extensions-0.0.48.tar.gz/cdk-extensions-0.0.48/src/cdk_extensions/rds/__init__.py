...
class DatabaseProxyEndpoint(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        database_proxy: aws_cdk.aws_rds.IDatabaseProxy,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseProxyEndpoint.__init__)
    ...
    def database_proxy(self) -> aws_cdk.aws_rds.IDatabaseProxy:
        return typing.cast(aws_cdk.aws_rds.IDatabaseProxy, jsii.get(self, "databaseProxy"))
    ...
    def database_proxy_endpoint_is_default(self) -> aws_cdk.IResolvable:
        return typing.cast(aws_cdk.IResolvable, jsii.get(self, "databaseProxyEndpointIsDefault"))
    ...
    def resource(self) -> aws_cdk.aws_rds.CfnDBProxyEndpoint:
        return typing.cast(aws_cdk.aws_rds.CfnDBProxyEndpoint, jsii.get(self, "resource"))
...
class DatabaseProxyEndpointAccess(
    ...
    def of(cls, role: builtins.str) -> "DatabaseProxyEndpointAccess":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseProxyEndpointAccess.of)
...
class DatabaseProxyEndpointProps(aws_cdk.ResourceProps):
    def __init__(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseProxyEndpointProps.__init__)
    ...
    def database_proxy(self) -> aws_cdk.aws_rds.IDatabaseProxy:
        ...
        return typing.cast(aws_cdk.aws_rds.IDatabaseProxy, result)
