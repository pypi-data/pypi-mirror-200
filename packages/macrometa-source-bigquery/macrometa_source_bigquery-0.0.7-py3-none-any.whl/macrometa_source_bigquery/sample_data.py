...
from macrometa_source_bigquery.sync_bigquery import _build_query, row_to_dict_singer_record, should_sync_column
...
def fetch_table(conn_info, stream):
    ...
    for row in query_job:
        record = row_to_dict_singer_record(row, properties, extract_tstamp)
