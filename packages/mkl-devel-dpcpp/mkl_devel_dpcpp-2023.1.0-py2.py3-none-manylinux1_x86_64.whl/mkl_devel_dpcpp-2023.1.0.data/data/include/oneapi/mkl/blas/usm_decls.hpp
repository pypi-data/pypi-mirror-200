...
ONEMKL_INLINE_DECLARE sycl::event symm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m, std::int64_t n, \
              T alpha, const T *a, std::int64_t lda, \
              const T *b, std::int64_t ldb, T beta, T *c, \
...
DLL_EXPORT sycl::event herk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k, \
              Treal alpha, const T *a, std::int64_t lda, \
              Treal beta, T *c, std::int64_t ldc, \
              compute_mode mode, const std::vector<sycl::event> &dependencies = {}); \
...
DLL_EXPORT sycl::event gbmv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n, std::int64_t kl, std::int64_t ku, T alpha, \
              const T *a, std::int64_t lda, \
              const T *x, std::int64_t incx, T beta, \
              T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event ger(sycl::queue &queue, std::int64_t m, std::int64_t n, T alpha, \
...
DLL_EXPORT sycl::event gerc(sycl::queue &queue, std::int64_t m, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
...
DLL_EXPORT sycl::event geru(sycl::queue &queue, std::int64_t m, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
              const T *y, std::int64_t incy, \
              T *a, std::int64_t lda, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event hbmv(sycl::queue &queue, uplo upper_lower, std::int64_t n, std::int64_t k, T alpha, \
              const T *a, std::int64_t lda, \
              const T *x, std::int64_t incx, T beta, \
              T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event hemv(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *a, std::int64_t lda, \
              const T *x, std::int64_t incx, T beta, \
              T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event her(sycl::queue &queue, uplo upper_lower, std::int64_t n, Treal alpha, \
              const T *x, std::int64_t incx, \
              T *a, std::int64_t lda, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event her2(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
              const T *y, std::int64_t incy, \
              T *a, std::int64_t lda, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event hpmv(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *a, \
              const T *x, std::int64_t incx, T beta, \
              T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event hpr(sycl::queue &queue, uplo upper_lower, std::int64_t n, Treal alpha, \
              const T *x, std::int64_t incx, \
...
DLL_EXPORT sycl::event hpr2(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
              const T *y, std::int64_t incy, \
              T *a, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event sbmv(sycl::queue &queue, uplo upper_lower, std::int64_t n, std::int64_t k, T alpha, \
              const T *a, std::int64_t lda, \
              const T *x, std::int64_t incx, T beta, \
              T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event symv(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *a, std::int64_t lda, \
              const T *x, std::int64_t incx, T beta, \
              T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event syr(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
              T *a, std::int64_t lda, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event syr2(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
              const T *y, std::int64_t incy, \
              T *a, std::int64_t lda, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event spmv(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *a, \
              const T *x, std::int64_t incx, T beta, \
              T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event spr(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
              T *a, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event spr2(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, \
              const T *x, std::int64_t incx, \
              const T *y, std::int64_t incy, \
              T *a, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event axpby(sycl::queue &queue, std::int64_t n, T alpha, const T *x, std::int64_t incx, const T beta, T *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event rotmg(sycl::queue &queue, T *d1, T *d2, T *x1, T y1, T *param, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event scal(sycl::queue &queue, std::int64_t n, Ts alpha, T *x, std::int64_t incx, const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event gemm_batch(sycl::queue &queue, transpose transa, transpose transb, \
                           std::int64_t m, std::int64_t n, std::int64_t k, Ts alpha, \
...
DLL_EXPORT sycl::event syrk_batch(sycl::queue &queue, \
                                      ...
                                      T alpha, const T *a, std::int64_t lda, std::int64_t stride_a, \
                                      T beta, T *c, std::int64_t ldc, std::int64_t stride_c, \
...
DLL_EXPORT sycl::event gemv_batch(sycl::queue &queue, transpose trans, \
              ...
              const T *a, std::int64_t lda, std::int64_t stridea, \
              const T *x, std::int64_t incx, std::int64_t stridex, T beta, \
...
DLL_EXPORT sycl::event axpy_batch(sycl::queue &queue, std::int64_t n, T alpha, \
                           const T *x, std::int64_t incx, std::int64_t stridex, \
                           T *y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size, \
                           const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event imatcopy(sycl::queue &queue, transpose trans, \
                                std::int64_t m, std::int64_t n, T alpha, T *ab, \
...
DLL_EXPORT sycl::event omatadd(sycl::queue &queue, transpose transa, transpose transb, \
                               std::int64_t m, std::int64_t n, \
                               T alpha, const T *a, std::int64_t lda, \
                               T beta, const T *b, std::int64_t ldb, \
                               T *c, std::int64_t ldc, \
                               const std::vector<sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event imatcopy_batch(sycl::queue &queue, transpose trans, \
                                          std::int64_t m, std::int64_t n, T alpha, T *ab, std::int64_t lda, \
...
DLL_EXPORT sycl::event omatadd_batch(sycl::queue &queue, transpose transa, transpose transb, \
                                         std::int64_t m, std::int64_t n, \
                                         T alpha, const T *a, std::int64_t lda, std::int64_t stride_a, \
                                         T beta, const T *b, std::int64_t ldb, std::int64_t stride_b, \
