...
class Manifest:
    def __init__(
        self,
        *,
        recipes: typing.Union[DeadlineDockerRecipes, typing.Dict[builtins.str, typing.Any]],
        schema: jsii.Number,
...
class Recipe:
    def __init__(
        ...
        *,
        ...
        title: builtins.str,
        build_args: typing.Optional[typing.Union[BuildArgs, typing.Dict[builtins.str, typing.Any]]] = None,
