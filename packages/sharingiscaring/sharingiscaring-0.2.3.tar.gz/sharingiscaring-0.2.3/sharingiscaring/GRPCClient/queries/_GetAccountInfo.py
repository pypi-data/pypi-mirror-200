...
class Mixin(_SharedConverters):
    ...
    def get_account_info(self, block_hash: str, hex_address:str=None, baker_id: int=None) -> CCD_AccountInfo:
        self.stub:QueriesStub
        blockHashInput          = self.generate_block_hash_input_from(block_hash)
        if baker_id is not None:
            accountIdentifierInput  = self.generate_account_identifier_input_from_baker_id(baker_id)
        elif hex_address:
