...
class Mixin(_SharedConverters):
    ...
    def get_blocks_at_height(self, block_height: int) -> list[CCD_BlockHash]:
        ...
        grpc_return_value:Iterator[BlocksAtHeightResponse] = self.stub.GetBlocksAtHeight(request=blocksAtHeightRequest)
