...
class GRPCClient(
    ...
    def __init__(self, hosts: list(dict) = None, async_check_connection: bool = False):
        self.host_index = 0
        if not hosts:
    ...
    def check_connection(self):
        try:
            ...
            # print(
            #     f"Connection OK for {self.hosts[self.host_index]['host']}:{self.hosts[self.host_index]['port']}"
            # )
