...
class RoverArmEnv(gym.Env):
    ...
    def __init__(self, render_mode = 'human', maxSteps=50 * 1000, isDiscrete=False, urdfRoot = pybullet_data.getDataPath()):
    ...
    def reset(self):
        ...
        self.roverarmUid = p.loadURDF("rover_arm/data/rover_arm.xml", basePosition=[ x_pos, y_pos ,-0.5])
