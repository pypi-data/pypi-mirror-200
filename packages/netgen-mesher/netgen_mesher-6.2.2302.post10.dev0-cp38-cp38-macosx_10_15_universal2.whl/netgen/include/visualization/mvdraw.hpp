...
namespace netgen
{
  ...
  class VisualSceneMesh : public VisualScene
  {
    ...
    unsigned select_framebuffer = 0;
    unsigned select_render_buffers[2];
    unsigned select_width = 0;
    unsigned select_height = 0;
  ...
  public:
    ...
    bool Unproject (int px, int py, Point<3> &p, bool select_on_clipping_plane);
  };
