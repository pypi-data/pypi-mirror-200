from typing import Tuple, List, TypedDict, Literal, Any, Union, Dict
...
class _BaseGen877345(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
