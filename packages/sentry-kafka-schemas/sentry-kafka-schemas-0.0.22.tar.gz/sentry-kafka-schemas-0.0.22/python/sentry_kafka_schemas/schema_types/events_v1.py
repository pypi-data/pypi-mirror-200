from typing import Union, Literal, Tuple, Any, Dict, TypedDict, List
...
class _BaseGen491201(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
