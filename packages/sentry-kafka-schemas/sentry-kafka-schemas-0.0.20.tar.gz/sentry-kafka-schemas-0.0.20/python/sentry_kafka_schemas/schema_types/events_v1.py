from typing import TypedDict, Tuple, Union, Dict, Any, List, Literal
...
class _BaseGen974421(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
