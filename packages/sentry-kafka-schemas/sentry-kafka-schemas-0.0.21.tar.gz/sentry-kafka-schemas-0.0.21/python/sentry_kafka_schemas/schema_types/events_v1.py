from typing import Union, Tuple, List, TypedDict, Literal, Any, Dict
...
class _BaseGen231624(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
