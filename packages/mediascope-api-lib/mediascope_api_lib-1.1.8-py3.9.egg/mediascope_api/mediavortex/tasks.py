...
class MediaVortexTask:
    ...
    def build_task(self, task_type, task_name='', date_filter=None, weekday_filter=None, daytype_filter=None,
        ...
        if reach_conditions is not None:
            tsk['reach_conditions'] = reach_conditions
    ...
    def build_timeband_task(self, task_name='', date_filter=None, weekday_filter=None, daytype_filter=None, 
                   company_filter=None, region_filter=None, time_filter=None, location_filter=None, basedemo_filter=None, 
                   targetdemo_filter=None, slices=None, statistics=None, scales=None, options=None):
        """
    ...
    def _get_text_name_for(self, df: pd.DataFrame, with_id=True):
        ...
        for col in df.columns:
            if col not in self.cats.tv_demo_attribs['entityName'].unique().tolist():
                continue
            _attrs = self.cats.tv_demo_attribs[self.cats.tv_demo_attribs['entityName'] == col].copy()[['valueId', 'valueName']]
    ...
    def _get_time_separator_name_for(self, df: pd.DataFrame):
        ...
        for col in df.columns:
            if col == 'programStartTime' or col == 'programFinishTime':
