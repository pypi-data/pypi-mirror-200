...
class MediaVortexCats:
    _urls = {
        ...
        'tv-channel': '/dictionary/tv/channel',
        'tv-channel-merge': '/dictionary/tv/channel-merge',
        ...
        'tv-ad-article': '/dictionary/tv/ad-article',
    ...
    def get_timeband_unit(self):
        ...
        # беру данные из первого элемента списка (необходимо уточнить структуру справочника)
        result = {
            'statistics': [i['name'] for i in units[0]['reports'][0]['statistics']],
            'slices': [i['name'] for i in units[0]['reports'][0]['slices']],
            'filters': [i['name'] for i in units[0]['reports'][0]['filters']]
        }
        
        result_prev = {
            'statistics': [ 'Reach000', 'ReachPer', 'AvReach000', 'AvReachPer', 'Rtg000', 'RtgPer', 'TgAffinPer', 'TAud',
                           'ATV', 'ATVReach', 'Share', 'Universe000', 'Sample', 'TTVRtg000', 'TTVRtgPer', 'TTVReach000',
                           'TTVReachPer', 'TTVAvReach000', 'TTVAvReachPer', 'TTVATV', 'TTVATVReach', 'SummedWeight',
                           'RespondentCount', 'Interval', 'SummedEventWeight', 'ZeroValue', 'Day', 'TTVTAud',
                           'TTVTAudDoubles', 'TTVSummedEventWeight', 'ReachN', 'OTS', 'TTVOTS', 'GRP', 'TTVGRP' ],
            'slices': [ 'researchDate', 'researchWeek', 'researchMonth', 'researchQuarter', 'researchYear',
                       ...
                       'locationEName', 'timeBand1', 'timeBand5', 'timeBand10', 'timeBand15', 'timeBand30', 'timeBand60',
                       'startTime', 'finishTime', 'roundedStartTime', 'roundedFinishTime', 'duration', 'roundedDuration',
                       'tvCompanyId', 'tvCompanyGroupId', 'tvCompanyCategoryId', 'tvCompanyName', 'tvCompanyEName',
                       'tvCompanyDescription', 'tvCompanyInformation', 'tvCompanyNotes', 'tvThematicID',
                       'tvCompanyHoldingID', 'tvCompanyMediaHoldingID', 'tvChannelId', 'tvChannelName', 'tvChannelEName',
                       'tvChannelDescription', 'tvNetId', 'tvNetName', 'tvNetEName', 'tvNetDescription', 'regionId',
                       'regionName', 'regionEName', 'scaleRange', 'reachInterval', 'geo', 'subGeo', 'sex', 'age',
                       'education', 'work', 'persNum', 'spendingsOnFood', 'tvNum', 'ageGroup', 'incomeGroupRussia',
                       'housewife', 'incomeEarner', 'video', 'incLevel', 'kidsNum', 'kidsAge1', 'kidsAge2', 'kidsAge3',
                       'kidsAge4', 'kidsAge5', 'kidsAge6', 'kidsAge7', 'status', 'business', 'enterprise', 'property',
                       'maritalStatus', 'lifeCycle', 'computer', 'internet', 'dacha', 'providerSputnik',
                       'providerAnalogEth', 'providerDigitalEth', 'providerAnalogCbl', 'providerDigitalCbl', 'hasVm',
                       'kidsAgeC1', 'kidsAgeC2', 'kidsAgeC3', 'kidsAgeC4', 'occupation', 'tradeIndustry', 'incomeGroup',
                       'federalOkrug', 'indexOkrug', 'incomeScale201401', 'equipmentV2', 'availTvPort1', 'availTvPort2',
                       'availTvPort3', 'availTvPort4', 'availTvPort5', 'availTvPort6', 'workCompIntern',
                       'housCompIntern', 'availAmsPort1', 'availAmsPort2', 'availAmsPort3', 'availAmsPort4',
                       'availAmsPort5', 'availAmsPort6', 'availAmsPort7', 'zdcHholdPersCnt', 'zdcIncomeGroup', 'zdcSex',
                       'zdcRAge18', 'zdcEducation', 'zdcWork', 'zodiacNet1View', 'zodiacNet2View', 'zodiacNet4View',
                       'zodiacNet11View', 'zodiacNet83View', 'zodiacNet13View', 'zodiacNet60View', 'zodiacNet12View',
                       'zodiacNet326View', 'zodiacNet206View', 'zodiacNet257View', 'zodiacNet205View',
                       'zodiacNet204View', 'zodiacNet255View', 'zodiacNet258View', 'zodiacNet259View',
                       'zodiacWorkPtview', 'zodiacWorkNptview', 'zodiacHolidayView', 'zodiacNet84View',
                       'zodiacNet260View', 'zodiacNet286View', 'zodiacNet40View', 'hhSignalKind1', 'hiddenFilterage1',
                       'hiddenFilterage18641', 'zodiacNet10View', 'zodiacNet270View', 'moscowRegion', 'wghPersNum1',
                       'existsSmartTv', 'isPrimaryPanel', 'isSecondaryPanel', 'secondPanelSeason',
                       'secondaryPanelMatrix', 'wghSuburbAgeGroup', 'zdcSocstat', 'wghLang', 'wghDachaTvExist',
                       'wghDachaSex', 'wghDachaAgeGroup16', 'smartTvYesNo', 'wghVideoGameWoAge', 'wghUsbTvHh',
                       'cubeCity', 'timezone0', 'hiddenFilterage18Zodiac', 'cube', 'cube100Plus100Minus', 'sputnikTv',
                       'geoFrom082020', 'hasRouterMeter', 'usageSmartTv', 'hiddenFilterage18640', 'rage1864',
                       'populationZdk', 'providerIptv', 'providerOtt', 'city' ],
            'filters': [ 'dataVersionId', 'researchDate', 'researchWeekDay', 'researchDayType', 'locationId', 'timeBand1',
                        'timeBand5', 'timeBand10', 'timeBand15', 'timeBand30', 'timeBand60', 'startTime', 'finishTime',
                        'roundedStartTime', 'roundedFinishTime', 'duration', 'roundedDuration', 'tvCompanyId',
                        'tvCompanyGroupId', 'tvCompanyCategoryId', 'tvThematicID', 'tvCompanyHoldingID',
                        'tvCompanyMediaHoldingID', 'tvChannelId', 'tvNetId', 'regionId', 'subjectGeoType', 'geo',
                        'subGeo', 'sex', 'age', 'education', 'work', 'persNum', 'spendingsOnFood', 'tvNum', 'ageGroup',
                        'incomeGroupRussia', 'housewife', 'incomeEarner', 'video', 'incLevel', 'kidsNum', 'kidsAge1',
                        'kidsAge2', 'kidsAge3', 'kidsAge4', 'kidsAge5', 'kidsAge6', 'kidsAge7', 'status', 'business',
                        'enterprise', 'property', 'maritalStatus', 'lifeCycle', 'computer', 'internet', 'dacha',
                        'providerSputnik', 'providerAnalogEth', 'providerDigitalEth', 'providerAnalogCbl',
                        'providerDigitalCbl', 'hasVm', 'kidsAgeC1', 'kidsAgeC2', 'kidsAgeC3', 'kidsAgeC4', 'occupation',
                        'tradeIndustry', 'incomeGroup', 'federalOkrug', 'indexOkrug', 'incomeScale201401',
                        'equipmentV2', 'availTvPort1', 'availTvPort2', 'availTvPort3', 'availTvPort4', 'availTvPort5',
                        'availTvPort6', 'workCompIntern', 'housCompIntern', 'availAmsPort1', 'availAmsPort2',
                        'availAmsPort3', 'availAmsPort4', 'availAmsPort5', 'availAmsPort6', 'availAmsPort7',
                        'zdcHholdPersCnt', 'zdcIncomeGroup', 'zdcSex', 'zdcRAge18', 'zdcEducation', 'zdcWork',
                        'zodiacNet1View', 'zodiacNet2View', 'zodiacNet4View', 'zodiacNet11View', 'zodiacNet83View',
                        'zodiacNet13View', 'zodiacNet60View', 'zodiacNet12View', 'zodiacNet326View', 'zodiacNet206View',
    ...
    def get_simple_unit(self):
        ...
        result = {
            'statistics': [ 'Reach000', 'ReachPer', 'Universe000', 'Sample', 'SampleAvg', 'Rtg000', 'RtgPer',
                           'Rtg000Avg', 'RtgPerAvg', 'Rtg000Sum', 'RtgPerSum', 'TAud', 'TAudAvg', 'TAudSum',
                           'ATV', 'ATVReach', 'Share', 'ShareAvg', 'Duration', 'DurationAvg', 'DurationSum',
                           'Interval', 'SummedWeight', 'RespondentCount', 'Day', 'SummedEventWeight',
                           'AvReach000', 'AvReachPer', 'TgAffinPer', 'TTVTAud', 'TTVRtg000', 'TTVRtg000Sum',
                           'TTVRtg000Avg', 'TTVRtgPerSum', 'TTVRtgPerAvg', 'TTVRtgPer', 'TTVInterval',
                           'CrossTabSummedWeight', 'Universe000Avg', 'CumReach000', 'CumReachPer', 'ATVSum',
                           'ATVAvg', 'Quantity', 'QuantitySum', 'CostByMinSum', 'CostByMin', 'CostByGRPSum',
                           'CostByGRP', 'ConsolidatedCostSum', 'ConsolidatedCost', 'ATVReachAvg',
                           'ATVReachSum', 'TgAffinPerAvg', 'OTS', 'GRP' ],
            'slices': [ 'researchDate', 'researchWeek', 'researchMonth', 'researchQuarter', 'researchYear',
                       'researchHalfYear', 'researchWeekDay', 'researchDayType', 'locationId', 
                       'locationName', 'locationEName', 'timeBand1', 'timeBand5', 'timeBand10', 
                       'timeBand15', 'timeBand30', 'timeBand60', 'tvCompanyId', 'tvCompanyGroupId', 
                       'tvCompanyCategoryId', 'tvCompanyName', 'tvCompanyEName', 'tvCompanyDescription', 
                       'tvChannelId', 'tvChannelName', 'tvChannelEName', 'tvChannelDescription', 'tvNetId', 
                       'tvNetName', 'tvNetEName', 'tvNetDescription', 'regionId', 'regionName', 
                       'regionEName', 'scaleRange', 'reachInterval', 'geo', 'subGeo', 'sex', 'age', 
                       'education', 'work', 'persNum', 'spendingsOnFood', 'tvNum', 'ageGroup', 
                       'incomeGroupRussia', 'housewife', 'incomeEarner', 'video', 'incLevel', 'kidsNum', 
                       'kidsAge1', 'kidsAge2', 'kidsAge3', 'kidsAge4', 'kidsAge5', 'kidsAge6', 
                       'kidsAge7', 'status', 'business', 'enterprise', 'property', 'maritalStatus', 
                       'lifeCycle', 'computer', 'internet', 'dacha', 'providerSputnik', 'providerAnalogEth', 
                       'providerDigitalEth', 'providerAnalogCbl', 'providerDigitalCbl', 'hasVm', 
                       'kidsAgeC1', 'kidsAgeC2', 'kidsAgeC3', 'kidsAgeC4', 'occupation', 'tradeIndustry', 
                       'incomeGroup', 'federalOkrug', 'indexOkrug', 'incomeScale201401', 'equipmentV2', 
                       'availTvPort1', 'availTvPort2', 'availTvPort3', 'availTvPort4', 'availTvPort5', 
                       'availTvPort6', 'workCompIntern', 'housCompIntern', 'availAmsPort1', 'availAmsPort2', 
                       'availAmsPort3', 'availAmsPort4', 'availAmsPort5', 'availAmsPort6', 'availAmsPort7', 
                       'zdcHholdPersCnt', 'zdcIncomeGroup', 'zdcSex', 'zdcRAge18', 'zdcEducation', 
                       'zdcWork', 'zodiacNet1View', 'zodiacNet2View', 'zodiacNet4View', 'zodiacNet11View', 
                       'zodiacNet83View', 'zodiacNet13View', 'zodiacNet60View', 'zodiacNet12View', 
                       'zodiacNet326View', 'zodiacNet206View', 'zodiacNet257View', 'zodiacNet205View', 
                       'zodiacNet204View', 'zodiacNet255View', 'zodiacNet258View', 'zodiacNet259View', 
                       'zodiacWorkPtview', 'zodiacWorkNptview', 'zodiacHolidayView', 'zodiacNet84View', 
                       'zodiacNet260View', 'zodiacNet286View', 'zodiacNet40View', 'hhSignalKind1', 
                       ...
                       'secondPanelSeason', 'secondaryPanelMatrix', 'wghSuburbAgeGroup', 'zdcSocstat', 
                       'wghLang', 'wghDachaTvExist', 'wghDachaSex', 'wghDachaAgeGroup16', 'smartTvYesNo', 
                       'wghVideoGameWoAge', 'wghUsbTvHh', 'cubeCity', 'timezone0', 'hiddenFilterage18Zodiac',
                       'cube', 'cube100Plus100Minus', 'sputnikTv', 'geoFrom082020', 'hasRouterMeter', 
                       'usageSmartTv', 'hiddenFilterage18640', 'rage1864', 'populationZdk', 'providerIptv', 
                       'providerOtt', 'city', 'programStartTime', 'programFinishTime', 
                       'programRoundedStartTime', 'programRoundedFinishTime', 'programDuration', 
                       'programRoundedDuration', 'programSpotId', 'programId', 'programName', 
                       'programEName', 'programTypeId', 'programTypeName', 'programTypeEName', 
                       'programCountryId', 'programCountryName', 'programCountryEName', 'programCategoryId', 
                       'programCategoryName', 'programCategoryEName', 'programSportId', 'programSportName', 
                       'programSportEName', 'programSportGroupId', 'programSportGroupName', 
                       'programSportGroupEName', 'programProducerId', 'programProducerName', 
                       'programProducerEName', 'programNotes', 'programLive', 'programNational', 
                       'programFirstIssueDate', 'programLanguageId', 'breaksStartTime', 'breaksFinishTime', 
                       'breaksRoundedStartTime', 'breaksRoundedFinishTime', 'breaksDuration', 
                       'breaksRoundedDuration', 'breaksSpotId', 'breaksId', 'breaksName', 'breaksEName', 
                       'breaksStyleId', 'breaksDistributionType', 'breaksPositionType', 'breaksContentType', 
                       'breaksPosition', 'GRPTypeId', 'GRPTypeName', 'GRPTypeEName', 'price', 'GRPPrice', 
                       'GRPPriceRub', 'GRPCost', 'GRPCostRub', 'adStartTime', 'adFinishTime', 
                       'adRoundedStartTime', 'adRoundedFinishTime', 'adDuration', 'adRoundedDuration', 
                       'adSpotId', 'adId', 'adName', 'adEName', 'adTypeId', 'advertiserListId', 
                       'advertiserListName', 'advertiserListEName', 'brandListId', 'brandListName', 
                       'brandListEName', 'modelListId', 'modelListName', 'modelListEName', 
                       'articleList2Id', 'articleList2Name', 'articleList2EName', 'articleList3Id', 
                       'articleList3Name', 'articleList3EName', 'articleList4Id', 'articleList4Name', 
                       'articleList4EName', 'adFirstIssueDate', 'subbrandListId', 'subbrandListName', 
                       'subbrandListEName', 'advertiserId', 'advertiserName', 'advertiserEName', 
                       'brandId', 'brandName', 'brandEName', 'subbrandId', 'subbrandName', 
                       'subbrandEName', 'modelId', 'modelName', 'modelEName', 'article2Id', 
            ...
            'filters': [ 'dataVersionId', 'researchDate', 'researchWeekDay', 'researchDayType', 'locationId', 
                        ...
                        'tvCompanyId', 'tvCompanyGroupId', 'tvCompanyCategoryId', 'tvChannelId', 'tvNetId',
                        'regionId', 'subjectGeoType', 'geo', 'subGeo', 'sex', 'age', 'education', 'work',
                        'persNum', 'spendingsOnFood', 'tvNum', 'ageGroup', 'incomeGroupRussia', 'housewife',
                        'incomeEarner', 'video', 'incLevel', 'kidsNum', 'kidsAge1', 'kidsAge2', 'kidsAge3', 
                        'kidsAge4', 'kidsAge5', 'kidsAge6', 'kidsAge7', 'status', 'business', 'enterprise', 
                        'property', 'maritalStatus', 'lifeCycle', 'computer', 'internet', 'dacha', 
                        'providerSputnik', 'providerAnalogEth', 'providerDigitalEth', 'providerAnalogCbl', 
                        'providerDigitalCbl', 'hasVm', 'kidsAgeC1', 'kidsAgeC2', 'kidsAgeC3', 'kidsAgeC4', 
                        'occupation', 'tradeIndustry', 'incomeGroup', 'federalOkrug', 'indexOkrug', 
                        'incomeScale201401', 'equipmentV2', 'availTvPort1', 'availTvPort2', 'availTvPort3', 
                        'availTvPort4', 'availTvPort5', 'availTvPort6', 'workCompIntern', 'housCompIntern', 
                        'availAmsPort1', 'availAmsPort2', 'availAmsPort3', 'availAmsPort4', 'availAmsPort5', 
                        'availAmsPort6', 'availAmsPort7', 'zdcHholdPersCnt', 'zdcIncomeGroup', 'zdcSex', 
                        'zdcRAge18', 'zdcEducation', 'zdcWork', 'zodiacNet1View', 'zodiacNet2View', 
                        'zodiacNet4View', 'zodiacNet11View', 'zodiacNet83View', 'zodiacNet13View', 
                        'zodiacNet60View', 'zodiacNet12View', 'zodiacNet326View', 'zodiacNet206View', 
                        'zodiacNet257View', 'zodiacNet205View', 'zodiacNet204View', 'zodiacNet255View', 
                        'zodiacNet258View', 'zodiacNet259View', 'zodiacWorkPtview', 'zodiacWorkNptview', 
                        'zodiacHolidayView', 'zodiacNet84View', 'zodiacNet260View', 'zodiacNet286View', 
                        'zodiacNet40View', 'hhSignalKind1', 'hiddenFilterage1', 'hiddenFilterage18641', 
                        'zodiacNet10View', 'zodiacNet270View', 'moscowRegion', 'wghPersNum1', 
                        'existsSmartTv', 'isPrimaryPanel', 'isSecondaryPanel', 'secondPanelSeason', 
                        'secondaryPanelMatrix', 'wghSuburbAgeGroup', 'zdcSocstat', 'wghLang', 
                        'wghDachaTvExist', 'wghDachaSex', 'wghDachaAgeGroup16', 'smartTvYesNo', 
                        'wghVideoGameWoAge', 'wghUsbTvHh', 'cubeCity', 'timezone0', 
                        'hiddenFilterage18Zodiac', 'cube', 'cube100Plus100Minus', 'sputnikTv', 
                        'geoFrom082020', 'hasRouterMeter', 'usageSmartTv', 'hiddenFilterage18640', 
                        'rage1864', 'populationZdk', 'providerIptv', 'providerOtt', 'city', 
                        'programStartTime', 'programFinishTime', 'programRoundedStartTime', 
                        'programRoundedFinishTime', 'programDuration', 'programRoundedDuration', 
                        'programSpotId', 'programId', 'programName', 'programEName', 'programTypeId', 
                        'programTypeName', 'programTypeEName', 'programCountryId', 'programCountryName', 
                        'programCountryEName', 'programCategoryId', 'programCategoryName', 
                        'programCategoryEName', 'programSportId', 'programSportName', 'programSportEName', 
                        'programSportGroupId', 'programSportGroupName', 'programSportGroupEName', 
                        'programProducerId', 'programProducerName', 'programProducerEName', 'programNotes', 
                        'programLive', 'programNational', 'programFirstIssueDate', 'programLanguageId', 
                        'breaksStartTime', 'breaksFinishTime', 'breaksRoundedStartTime', 
                        'breaksRoundedFinishTime', 'breaksDuration', 'breaksRoundedDuration', 
                        'breaksSpotId', 'breaksId', 'breaksName', 'breaksEName', 'breaksStyleId', 
                        'breaksDistributionType', 'breaksPositionType', 'breaksContentType', 
                        'breaksPosition', 'GRPTypeId', 'GRPTypeName', 'GRPTypeEName', 'price', 
                        'GRPPrice', 'GRPPriceRub', 'GRPCost', 'GRPCostRub', 'adStartTime', 
                        'adFinishTime', 'adRoundedStartTime', 'adRoundedFinishTime', 'adDuration', 
                        'adRoundedDuration', 'adSpotId', 'adId', 'adName', 'adEName', 'adTypeId', 
                        'advertiserListId', 'advertiserListName', 'advertiserListEName', 'brandListId', 
                        'brandListName', 'brandListEName', 'modelListId', 'modelListName', 'modelListEName', 
                        'articleList2Id', 'articleList2Name', 'articleList2EName', 'articleList3Id', 
                        'articleList3Name', 'articleList3EName', 'articleList4Id', 'articleList4Name', 
                        'articleList4EName', 'adFirstIssueDate', 'subbrandListId', 'subbrandListName', 
                        'subbrandListEName', 'advertiserId', 'advertiserName', 'advertiserEName', 
                        'brandId', 'brandName', 'brandEName', 'subbrandId', 'subbrandName', 'subbrandEName', 
                        'modelId', 'modelName', 'modelEName', 'article2Id', 'article2Name', 'article2EName', 
                        'article3Name', 'article3EName', 'article4Name', 'article4EName' 
                        ]
        }
    ...
    def get_crosstab_unit(self):
        ...
        result = {
            'statistics': [ 'SampleAvg', 'Universe000', 'Rtg000', 'Rtg000Avg', 'RtgPerAvg', 'Rtg000Sum', 'RtgPerSum', 'TAud',
                           'TAudAvg', 'TAudSum', 'ShareAvg', 'DurationAvg', 'DurationSum', 'Interval', 'RespondentCount',
                           'Day', 'SummedEventWeight', 'AvReach000', 'AvReachPer', 'TgAffinPer', 'TTVTAud',
                           'TTVRtg000Sum', 'TTVRtg000Avg', 'TTVRtgPerSum', 'TTVRtgPerAvg', 'SummedWeight',
            ...
            'slices': [ 'researchDate', 'researchWeek', 'researchMonth', 'researchQuarter', 'researchYear', 'researchHalfYear',
                       'researchWeekDay', 'researchDayType', 'locationId', 'locationName', 'locationEName', 'timeBand1',
                       'timeBand5', 'timeBand10', 'timeBand15', 'timeBand30', 'timeBand60', 'tvCompanyId',
                       'tvCompanyGroupId', 'tvCompanyCategoryId', 'tvCompanyName', 'tvCompanyEName',
                       'tvCompanyDescription', 'tvCompanyInformation', 'tvCompanyNotes', 'tvThematicID',
                       'tvCompanyHoldingID', 'tvCompanyMediaHoldingID', 'tvChannelId', 'tvChannelName',
                       ...
                       'hiddenFilterage1', 'hiddenFilterage18641', 'zodiacNet10View', 'zodiacNet270View', 'moscowRegion',
                       'wghPersNum1', 'existsSmartTv', 'isPrimaryPanel', 'isSecondaryPanel', 'secondPanelSeason',
                       'secondaryPanelMatrix', 'wghSuburbAgeGroup', 'zdcSocstat', 'wghLang', 'wghDachaTvExist',
                       'wghDachaSex', 'wghDachaAgeGroup16', 'smartTvYesNo', 'wghVideoGameWoAge', 'wghUsbTvHh',
                       'cubeCity', 'timezone0', 'hiddenFilterage18Zodiac', 'cube', 'cube100Plus100Minus', 'sputnikTv',
                       'geoFrom082020', 'hasRouterMeter', 'usageSmartTv', 'hiddenFilterage18640', 'rage1864',
                       'populationZdk', 'providerIptv', 'providerOtt', 'city', 'programStartTime', 'programFinishTime',
                       'programRoundedStartTime', 'programRoundedFinishTime', 'programDuration',
                       ...
                       'brandEName', 'subbrandId', 'subbrandName', 'subbrandEName', 'modelId', 'modelName', 'modelEName',
                       'article2Id', 'article2Name', 'article2EName', 'article3Name', 'article3EName', 'article4Name',
                       'article4EName' ],
            'filters': [ 'dataVersionId', 'researchDate', 'researchWeekDay', 'researchDayType', 'locationId', 'timeBand1',
                        'timeBand5', 'timeBand10', 'timeBand15', 'timeBand30', 'timeBand60', 'tvCompanyId',
                        'tvCompanyGroupId', 'tvCompanyCategoryId', 'tvChannelId', 'tvNetId', 'regionId',
    ...
    def get_tv_tv_ad(self, tv_ad_type_ids=None, advertiser_list_ids=None, brand_list_ids=None, model_list_ids=None,
                     ...
                     ename=None, notes=None, standard_durations=None, file_type=None, order_by=None, order_dir=None, offset=None,
    ...
    def get_tv_research_day_type(self, research_day_type=None, name=None, order_by=None, order_dir=None, offset=None, limit=None, use_cache=True):
        """
        Получить типы дней
    ...
    def get_tv_program_category(self, program_type_ids=None, program_type_category_nums=None, ids=None, name=None, ename=None,
                                short_name=None, short_ename=None, notes=None, order_by=None, order_dir=None,
                                offset=None, limit=None, use_cache=True):
        """
    ...
    def get_tv_net(self, net_ids=None, name=None, ename=None, notes=None, order_by=None,
                   order_dir=None, offset=None, limit=None, use_cache=True):
        """
        Получить сети
        ...
        return self._get_dict('tv-net', search_params, body_params, offset, limit, use_cache)
    ...
    def get_tv_company(self, tv_channel_ids=None, tv_net_ids=None, region_ids=None, tv_company_group_ids=None,
                       tv_company_category_ids=None, name=None, ename=None, ids=None, notes=None, status=None,
        ...
        return self._get_dict('tv-company', search_params, body_params, offset, limit, use_cache)
    ...
    def get_tv_channel(self, channel_ids=None, region_ids=None, name=None, ename=None, notes=None,
                       order_by=None, order_dir=None, offset=None, limit=None, use_cache=True):
        """
        Получить телеканалы
        ...
        ----------
        channel_ids : list
            Поиск по списку идентификаторов телеканалов
        
        region_ids : list
            Поиск по списку идентификаторов регионов
            
        name : string
            Поиск по имени телеканала
        
        ename : string
            Поиск по англоязычному имени телеканала
        ...
        return self._get_dict('tv-channel', search_params, body_params, offset, limit, use_cache)

    def get_tv_channel_merge(self, ids=None, name=None, ename=None, notes=None, start_date=None,
                             finish_date=None, status=None, order_by=None, order_dir=None,
                             offset=None, limit=None, use_cache=True):
        """
        Получить объединенные телеканалы

        Parameters
        ----------
        ids : list
            Поиск по списку идентификаторов объединенных телеканалов
        ...
        media : DataFrame
            ...
            DataFrame с объединенными телеканалами
        """
        ...
        return self._get_dict('tv-channel-merge', search_params, body_params, offset, limit, use_cache)
    ...
    def get_tv_ad_total(self, tv_ad_ids=None, research_month=None, tv_ad_type_ids=None, tv_company_ids=None, ad_style_ids=None, 
                        advertiser_ids=None, brand_ids=None, subbrand_ids=None, model_ids=None, region_ids=None, article1_ids=None,
                        article2_ids=None, article3_ids=None, article4_ids=None, file_type=None, order_by=None, order_dir=None, offset=None,
                        limit=None, use_cache=True):
        """
    ...
    def get_tv_ad_month(self, tv_company_ids=None, research_month=None, ad_ids=None, from_tv_company_ids=None, 
                        from_research_month=None, volume=None, count=None, price=None, grp_price=None, issue_status=None,
                        cnd_cost=None, distribution=None, cost_rub=None, grp_cost_rub=None, cnd_cost_rub=None, order_by=None,
                        order_dir=None, offset=None, limit=None, use_cache=True):
        """
    ...
    def get_tv_ad_article(self, tv_ad_ids=None, article_ids=None, level=None, order_by=None, order_dir=None, offset=None,
                          limit=None, use_cache=True):
        """
        Получить рекламную статью
        ...
        media : DataFrame
            ...
            DataFrame с рекламными статьями
        """
        ...
        return self._get_dict('tv-ad-article', search_params, body_params, offset, limit, use_cache)
    ...
    def get_tv_demo_attribute(self, ids=None, value_ids=None, names=None, col_names=None, value_names=None,
        ...
        body_params = {
            ...
            "demoAttributeName": names, 
            "demoAttributeColName": col_names,
            "demoAttributeValueName": value_names
        }
