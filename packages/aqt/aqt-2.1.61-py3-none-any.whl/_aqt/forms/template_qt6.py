...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.front_button = QtWidgets.QRadioButton(self.template_box)
        ...
        self.back_button = QtWidgets.QRadioButton(self.template_box)
        ...
        self.style_button = QtWidgets.QRadioButton(self.template_box)
        ...
        self.search_edit = QtWidgets.QLineEdit(self.template_box)
        self.search_edit.setObjectName("search_edit")
        self.verticalLayout.addWidget(self.search_edit)
        self.changes_affect_label = QtWidgets.QLabel(self.template_box)
        ...
        self.edit_area = QtWidgets.QTextEdit(self.template_box)
