...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/fhir/r4/proto/core/resources/enrollment_request.proto',
...
_ENROLLMENTREQUEST_STATUSCODE.fields_by_name['value'].enum_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_codes__pb2._FINANCIALRESOURCESTATUSCODE_VALUE
_ENROLLMENTREQUEST_STATUSCODE.fields_by_name['id'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._STRING
_ENROLLMENTREQUEST_STATUSCODE.fields_by_name['extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_ENROLLMENTREQUEST_STATUSCODE.containing_type = _ENROLLMENTREQUEST
_ENROLLMENTREQUEST.fields_by_name['id'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._ID
_ENROLLMENTREQUEST.fields_by_name['meta'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._META
_ENROLLMENTREQUEST.fields_by_name['implicit_rules'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._URI
_ENROLLMENTREQUEST.fields_by_name['language'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODE
_ENROLLMENTREQUEST.fields_by_name['text'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._NARRATIVE
_ENROLLMENTREQUEST.fields_by_name['contained'].message_type = google_dot_protobuf_dot_any__pb2._ANY
_ENROLLMENTREQUEST.fields_by_name['extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_ENROLLMENTREQUEST.fields_by_name['modifier_extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_ENROLLMENTREQUEST.fields_by_name['identifier'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._IDENTIFIER
_ENROLLMENTREQUEST.fields_by_name['status'].message_type = _ENROLLMENTREQUEST_STATUSCODE
_ENROLLMENTREQUEST.fields_by_name['created'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._DATETIME
_ENROLLMENTREQUEST.fields_by_name['insurer'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_ENROLLMENTREQUEST.fields_by_name['provider'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_ENROLLMENTREQUEST.fields_by_name['candidate'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_ENROLLMENTREQUEST.fields_by_name['coverage'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
...
EnrollmentRequest = _reflection.GeneratedProtocolMessageType('EnrollmentRequest', (_message.Message,), {
  ...
  'StatusCode' : _reflection.GeneratedProtocolMessageType('StatusCode', (_message.Message,), {
    ...
    '__module__' : 'google.fhir.r4.proto.core.resources.enrollment_request_pb2'
