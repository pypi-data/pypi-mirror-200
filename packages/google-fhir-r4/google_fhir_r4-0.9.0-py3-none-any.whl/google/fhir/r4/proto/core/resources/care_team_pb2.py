...
_CARETEAM_STATUSCODE.fields_by_name['value'].enum_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_codes__pb2._CARETEAMSTATUSCODE_VALUE
_CARETEAM_STATUSCODE.fields_by_name['id'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._STRING
_CARETEAM_STATUSCODE.fields_by_name['extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_CARETEAM_STATUSCODE.containing_type = _CARETEAM
_CARETEAM_PARTICIPANT.fields_by_name['id'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._STRING
_CARETEAM_PARTICIPANT.fields_by_name['extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_CARETEAM_PARTICIPANT.fields_by_name['modifier_extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_CARETEAM_PARTICIPANT.fields_by_name['role'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODEABLECONCEPT
_CARETEAM_PARTICIPANT.fields_by_name['member'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_CARETEAM_PARTICIPANT.fields_by_name['on_behalf_of'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_CARETEAM_PARTICIPANT.fields_by_name['period'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._PERIOD
_CARETEAM_PARTICIPANT.containing_type = _CARETEAM
_CARETEAM.fields_by_name['id'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._ID
_CARETEAM.fields_by_name['meta'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._META
_CARETEAM.fields_by_name['implicit_rules'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._URI
_CARETEAM.fields_by_name['language'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODE
_CARETEAM.fields_by_name['text'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._NARRATIVE
_CARETEAM.fields_by_name['contained'].message_type = google_dot_protobuf_dot_any__pb2._ANY
_CARETEAM.fields_by_name['extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_CARETEAM.fields_by_name['modifier_extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_CARETEAM.fields_by_name['identifier'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._IDENTIFIER
_CARETEAM.fields_by_name['status'].message_type = _CARETEAM_STATUSCODE
_CARETEAM.fields_by_name['category'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODEABLECONCEPT
_CARETEAM.fields_by_name['name'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._STRING
_CARETEAM.fields_by_name['subject'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_CARETEAM.fields_by_name['encounter'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_CARETEAM.fields_by_name['period'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._PERIOD
_CARETEAM.fields_by_name['participant'].message_type = _CARETEAM_PARTICIPANT
_CARETEAM.fields_by_name['reason_code'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODEABLECONCEPT
_CARETEAM.fields_by_name['reason_reference'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_CARETEAM.fields_by_name['managing_organization'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_CARETEAM.fields_by_name['telecom'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CONTACTPOINT
_CARETEAM.fields_by_name['note'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._ANNOTATION
...
CareTeam = _reflection.GeneratedProtocolMessageType('CareTeam', (_message.Message,), {
  ...
  'StatusCode' : _reflection.GeneratedProtocolMessageType('StatusCode', (_message.Message,), {
    ...
    '__module__' : 'google.fhir.r4.proto.core.resources.care_team_pb2'
