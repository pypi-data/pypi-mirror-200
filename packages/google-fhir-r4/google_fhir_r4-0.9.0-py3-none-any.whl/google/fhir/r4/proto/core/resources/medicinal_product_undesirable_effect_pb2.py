...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/fhir/r4/proto/core/resources/medicinal_product_undesirable_effect.proto',
...
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['id'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._ID
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['meta'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._META
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['implicit_rules'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._URI
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['language'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODE
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['text'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._NARRATIVE
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['contained'].message_type = google_dot_protobuf_dot_any__pb2._ANY
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['modifier_extension'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._EXTENSION
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['subject'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._REFERENCE
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['symptom_condition_effect'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODEABLECONCEPT
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['classification'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODEABLECONCEPT
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['frequency_of_occurrence'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._CODEABLECONCEPT
_MEDICINALPRODUCTUNDESIRABLEEFFECT.fields_by_name['population'].message_type = google_dot_fhir_dot_r4_dot_proto_dot_core_dot_datatypes__pb2._POPULATION
...
MedicinalProductUndesirableEffect = _reflection.GeneratedProtocolMessageType('MedicinalProductUndesirableEffect', (_message.Message,), {
  ...
  '__module__' : 'google.fhir.r4.proto.core.resources.medicinal_product_undesirable_effect_pb2'
