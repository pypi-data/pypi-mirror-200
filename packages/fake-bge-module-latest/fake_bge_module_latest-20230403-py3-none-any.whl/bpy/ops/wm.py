...
def blenderplayer_start():
    ''' Launch the blender-player with the current blend-file :file: startup/bl_operators/wm.py\:2125 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L2125> _
...
def operator_cheat_sheet():
    ''' List all the operators in a text-block, useful for scripting :file: startup/bl_operators/wm.py\:2175 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L2175> _
...
def ply_export(filepath: str = "",
               ...
               export_colors: typing.Union[int, str] = 'SRGB',
               export_triangulated_mesh: bool = False,
    ...
    :type export_colors: typing.Union[int, str]
    :param export_triangulated_mesh: 4
    :type export_triangulated_mesh: bool
...
def ply_import(
        ...
        import_colors: typing.Union[int, str] = 'SRGB',
        filter_glob: str = "*.ply"):
    ...
    :type import_colors: typing.Union[int, str]
    :param filter_glob: Extension Filter
    :type filter_glob: str
    '''
...
def toolbar():
    ''' Undocumented, consider contributing <https://developer.blender.org/> __. :file: startup/bl_operators/wm.py\:2361 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L2361> _
...
def toolbar_fallback_pie():
    ''' Undocumented, consider contributing <https://developer.blender.org/> __. :file: startup/bl_operators/wm.py\:2385 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L2385> _
...
def toolbar_prompt():
    ''' Leader key like functionality for accessing tools :file: startup/bl_operators/wm.py\:2485 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L2485> _
