...
def _gen(s: str):
    ...
    for md in seed_content['models']:
        ...
        md_schema['read_fields'] = list(iterate_layout(md_schema['read'], groups))
        md_schema['form_fields'] = list(iterate_layout(md_schema['form'], groups))
    #
