...
import deta_ecosystem_services.self_service.pipeline_metadata as davt_pl_metadata
import deta_ecosystem_services.self_service.dataset_metadata as davt_ds_metadata
import deta_ecosystem_services.self_service.environment_metadata as davt_env_metadata
import deta_ecosystem_services.self_service.logging_metadata as davt_log_metadata
import deta_ecosystem_services.tech_environment_service.job_core as davt_job_core
import deta_ecosystem_services.tech_environment_service.repo_core as davt_repo_core
import deta_ecosystem_services.tech_environment_service.dataset_crud as davt_ds_crud
import deta_ecosystem_services.tech_environment_service.dataset_core as davt_ds_core
import deta_ecosystem_services.tech_environment_service.environment_file as davt_env_file
...
class JobMetaData:
    ...
    def install_cluster_library(config) -> str:
        ...
        davt_services_python_version = config["davt_services_python_version"]
        davt_services_python_version = davt_services_python_version.replace("v", "")
        library_folder = f"{davt_root_project_url}dist/"
        library_file = f"{library_folder}davt_services_python-{davt_services_python_version}-py3-none-any.whl"
