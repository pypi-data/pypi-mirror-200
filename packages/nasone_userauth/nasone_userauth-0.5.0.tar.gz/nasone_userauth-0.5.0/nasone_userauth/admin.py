...
def attach_page_head(page: Page) -> Page:
    ...
    page.body = [
        Html(
            ...
            f'width: 48px;"><span style="font-size: 32px; font-weight: bold;">Nasone Admin</span></div>'
            # f'<div style="width: 100%; text-align: center; color: rgba(0, 0, 0, 0.45); margin-bottom: 40px;">{desc}</div>'
        ),
        Grid(columns=[{"body": [page.body], "lg": 4, "md": 8, "valign": "middle"}], align="center", valign="middle"),
    ]
    return page
