...
APP_ID = st.secrets["APP_ID"] # used to authenticate a user in a cognito group.
class Authentication:
    ...
    def cognito_authenticate(self, auth_code=None, access_token=None):
        ...
        with st.spinner(text="Signing in..."):
            ...
            is_in_group = False
            if APP_ID:
                is_client_id, is_in_group = self.user_token_decode(access_token, CLIENT_ID, APP_ID)
                ...
                is_client_id, is_in_group = self.user_token_decode(access_token, CLIENT_ID)
