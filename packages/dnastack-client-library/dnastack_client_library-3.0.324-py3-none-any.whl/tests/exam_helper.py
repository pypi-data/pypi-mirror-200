...
class BaseTestCase(TestCase):
    ...
    def setUpClass(cls) -> None:
        super().setUpClass()
        cls._base_logger.info(f'Class {cls.__name__}: Initialization: Begin')
        ...
        cls._base_logger.info(f'Class {cls.__name__}: Initialization: End')

    @classmethod
    def tearDownClass(cls) -> None:
        cls._base_logger.info(f'Class {cls.__name__}: Cleanup: Begin')
        ...
        cls._base_logger.info(f'Class {cls.__name__}: Cleanup: End')
...
class BasePublisherTestCase(BaseTestCase):
    ...
    @classmethod
    def get_factory(cls) -> EndpointRepository:
        return use(cls.explorer_urls[0], no_auth=True)
