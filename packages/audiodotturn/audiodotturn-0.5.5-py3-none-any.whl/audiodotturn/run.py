...
def extract_commands(args, adt: AudioDotTurn):
    ...
    if args.file:
        ...
        if args.multi:
            ...
            extractions = adt.extract_files(adt.files_in_dir(args.dir))
...
def construct_commands(args, adt: AudioDotTurn):
    ...
    if args.file:
        ...
        extraction = adt.extract_files(adt.files_in_dir(args.dir))
        produce_extract_report(extraction, console)
    ...
    success, failure = produce_construct_report(results, console)
...
def database_commands(args, adt: AudioDotTurn):
    ...
    if args.updatefile:
    ...
    elif args.updatemulti or args.updatedir:
        ...
        if args.updatemulti:
            ...
            extractions = adt.extract_files(adt.files_in_dir(args.updatedir))
...
def produce_construct_report(results, console):
    """
