...
class StringAlignment:
    ...
    def get_match_weight(self, 
        ...
        """
            ...
            Arguments:
                c1: The first character/string.
                c2: The second character/string.

            Returns:
                The match weight of the two characters/strings.
        """
    ...
    def get_gap_weight(self,
        ...
        """
            Definition:
                This function returns the gap weight of a character/string.

            Arguments:
                c: The character/string.

            Returns:
                The gap weight of the character/string.
        """
    ...
    def get_score(self,
        ...
        """
            Definition:
                This function returns the score of a character/string pair.
            ...
            Returns:
                The score of the character/string pair.
        """
    ...
    def get_alignment_strings_and_indices(self,
        ...
        """
            ...
            Arguments:
                str1: The first string separated by the separator.
                str2: The second string separated by the separator.
                separator: The separator (delimiter) of the string.
...
class NeedlemanWunsch(StringAlignment):
    ...
    def __init__(self,
        ...
        """
        super().__init__(match_weight, mismatch_weight, gap_weight, match_dict, gap_char)
    ...
    def backtrack(self,
        ...
        .. note::
            ...
            * The backtracking step has a time complexity of :math:`O(m + n)`, where m and n are the lengths of the strings str1 and str2, respectively.
        """
    ...
    def get_alignment(self,
        ...
        .. note::
            * There might be multiple optimal alignments. This function returns one of the optimal alignments.
            * The time complexity of this function is :math:`O(mn)`, where m and n are the lengths of the strings str1 and str2, respectively.
            * The space complexity of this function is :math:`O(mn)`.
        ...
        Examples:
            ...
            >>> nw.print_alignment(nw.get_alignment(["a", "b", "bb"], ["a", "bb", "b", "bb"]))
            a | -  | b | bb
            a | bb | b | bb

            >>> nw.print_alignment(nw.get_alignment("abcbd", "abcde"))
            a | b | c | b | d | -
            a | b | c | - | d | e
        """
...
class Hirschberg(NeedlemanWunsch):
    def __init__(self,
        ...
        .. note::
            ...
            * The time complexity of Hirschberg's algorithm is :math:`O(mn)`, where m and n are the lengths of the strings str1 and str2, respectively.
            * The space complexity of Hirschberg's algorithm is, on the other hand, :math:`O(min(n, m))`.
            * We benefited from the following resources to implement this class: [K2015]_, [W2012]_, [M2010]_, [K2015]_.
        ...
        .. [K2015] Kingsford, Carl. Lecture 7: Dynamic Programming. 2002. Carnegie Mellon University. (https://www.cs.cmu.edu/~ckingsf/class/02-714/Lec07-linspace.pdf) (Accessed on 02-16-2023).
        """

        # Initialize the Needleman-Wunsch algorithm.
        super().__init__(match_weight, mismatch_weight, gap_weight, gap_char)
    ...
    def get_alignment(self,
        ...
        Examples:
            >>> from string2string.alignment import Hirschberg
            >>> hr = Hirschberg(
            ...     match_weight = 2,
            ...     mismatch_weight = -1,
            ...     gap_weight = - 2,
            ...
            >>> seq1 = "AGTACGCA"
            >>> seq2 = "TATGC"
            >>> align_seq1, align_seq2 = hr.get_alignment(seq1, seq2)
            >>> hr.print_alignment(align_seq1, align_seq2)
            A | G | T | A | C | G | C | A
            - | - | T | A | T | G | C | -
        ...
        # Remove the trailing " | " from the aligned strings.
...
class SmithWaterman(NeedlemanWunsch):
    def __init__(self,
        ...
        .. note::
            ...
            * The space and time complexities of the Smith-Waterman algorithm are the same as the Needleman-Wunsch algorithm, that is, :math:`O(mn)` and :math:`O(mn)`, respectively, where m and n are the lengths of the two strings (or lists of strings).
        """
    ...
    def get_alignment(self,
        ...
        Examples:
            ...
            >>> # Define a function to print the aligned strings.
            >>> def print_nice(pair):
            ...     print(pair[0])
            ...     print(pair[1])
            
            >>> print_nice(sw.get_alignment("TACGGGCCCGCTAC", "TAGCCCTATCGGTCA"))
            T | A | - | C | G | G
            T | A | T | C | G | G

            >>> print_nice(sw.get_alignment("GAGTCGCTACGGGCCCGCTAC", "TAGCCTATGCACCTATCGGTCA"))
            C | T | A | - | C | G | G
            C | T | A | T | C | G | G
        """
...
class DTW:
    ...
    def get_alignment_path(self,
        ...
        .. note::
            ...
            * The time complexity of the DTW algorithm is :math:`O(nm)`, where n and m are the lengths of the two sequences, respectively.

        Examples:
            >>> from string2string.alignment import DTW
            >>> dtw = DTW()

            >>> dtw.get_alignment_path([1, 2, 3], [1, 2, 3, 4])
            [(0, 0), (1, 1), (2, 2), (2, 3)]

            >>> dtw.get_alignment_path("abc", "abcd")
            [(0, 0), (1, 1), (2, 2), (2, 3)]

            >>> dtw.get_alignment_path(["a", "b", "c"], ["a", "b", "c", "d"])
            [(0, 0), (1, 1), (2, 2), (2, 3)]
...
class LongestCommonSubsequence:
    ...
    def __init__(self, 
        ...
        r"""
        This function initializes the Longest Common Subsequence (LCSubsequenceuence) class.
    ...
    def compute(self,
        ...
        Arguments:
            str1 (str or list of str): The first string (or list of strings).
            str2 (str or list of str): The second string (or list of strings).
            returnCandidates (bool): Whether to return the candidates for the longest common subsequence.
            boolListOfList (bool): Whether the inputs are lists of strings.
        ...
        .. note::
           ...
           * This optimization reduces the space complexity of the algorithm to :math:`\mathcal{O}(m)`, where m is the length of the shorter input string. This optimization is particularly useful when one of the input strings is much shorter than the other, as it can significantly reduce the amount of memory required to solve the problem.

        Examples:
            >>> from string2string.alignment.algs import LongestCommonSubsequence
            >>> longest_common_subsequence = LongestCommonSubsequence()

            >>> longest_common_subsequence.compute("aa", "aa", returnCandidates=True)
            (2.0, ['aa'])
            >>> longest_common_subsequence.compute("abcd", "xcxaaabydy", returnCandidates=True)
            (3.0, ['abd'])
            >>> longest_common_subsequence.compute("aabbccdd", "dcdcbaba", returnCandidates=True)
            (2.0, ['dd', 'bb', 'cc', 'cd', 'aa', 'ab'])
            >>> longest_common_subsequence.compute(["a", "bb", "c"],["a", "bb", "c"], returnCandidates=True, boolListOfList=True)
            3.0, [['a', 'bb', 'c']])
        """
        # Lengths of strings str1 and str2, respectively.
        n = len(str1)
...
class LongestCommonSubstring(LongestCommonSubsequence):
    ...
    def compute(self,
        ...
        Returns:
            * If returnCandidates is False, then the length of the longest common substring between the two strings.
            ( If returnCandidates is True, then the set of longest common substrings between the two strings (or lists of strings) is also returned.
        ...
        Examples:
            >>> from string2string.alignment.algs import LongestCommonSubstring
            >>> longest_common_substring = LongestCommonSubstring()

            >>> longest_common_substring.compute("aa", "aa", returnCandidates=True)
            (2.0, ['aa'])
            >>> longest_common_substring.compute("xyxy", "yxyx", returnCandidates=True)
            (3, ['yxy', 'xyx'])
            >>> longest_common_substring.compute("aabbaa", "aa", returnCandidates=True)
            (2, ['aa'])
            >>> longest_common_substring.compute(" julia ", "  julie ", returnCandidates=True)
            (5, [' juli'])
        """
        # Lengths of strings str1 and str2, respectively.
        n = len(str1)
        ...
        if returnCandidates:
            ...
            return longest_common_substring_length, list(set(longest_common_substring_candidates))
