...
**    $ tb datasource rm {datasource}""")
    warning_name_already_exists = warning_message("** Warning: {name} already exists, skipping. {force_message}")
    ...
    info_aborted = warning_message('** Operation aborted')
    info_overwriting = warning_message('** Overwriting...')
