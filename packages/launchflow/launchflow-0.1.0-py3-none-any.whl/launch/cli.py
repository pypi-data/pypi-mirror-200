...
app.add_typer(flows.app, name="flow", help='Perform operations on a flow.')
...
MODULE_HELP_TEXT = 'whether or not to run the python entry point as a module. e.g. python -m entrypoint'  # noqa: E501
...
@app.command(help='Create the launchflow host.')
def run(module: bool = typer.Option(False, '-m', help=MODULE_HELP_TEXT),
        entrypoint: str = typer.Argument(
            ..., help='The entry point to run your flow pipeline.'),
