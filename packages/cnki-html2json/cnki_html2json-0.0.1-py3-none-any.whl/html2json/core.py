...
def html2json(paper_html:str,mode:str='structure',export=False,export_path=None):
    ...
    mode: 模式，structure为结构化文本(默认)，plain为纯文本
...
def start_crawl(start_paper_index=1,end_paper_index=None,mode:str='structure',save_path='data',log=True,wait_time=120,browser_type='Chrome',debug=False):
    """爬取cnki网站的论文
