...
def markdown_to_html(value):
    ...
    Note that the resulting HTML is not safe for rendering it directly on a page as
    HTML.
...
def strip_markdown(value):
    ...
    May not strip all directives, since some may not be supported by the used markdown
    renderer.
    ...
    if value is not None:
        ...
        # Second, render markdown directives.
