...
class QCArchiveStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the QCArchive step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return qcarchive_step.QCArchive(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return qcarchive_step.TkQCArchive(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return QCArchiveStep.my_description
