...
def get_config():
  filename = os.path.join(os.getenv('CONFIGS'), 'fhir.json')
  config_dict = None
...
def get_fhir_pseudonym(ptid):
  config_dict = get_config()
  
  if config_dict is None:
    return None
  
  interface_url = config_dict['interface_url']
  auth_server_url = config_dict['auth_server_url']
  client_id = config_dict['client_id']
  client_secret = config_dict['client_secret']
  identifier_system = config_dict['identifier_system']
