...
with open(pkg_resources.resource_filename(f"{__name__},{__name__}", 'bancos_codigos.json')) as f:
...
with open(pkg_resources.resource_filename(f"{__name__},{__name__}",'bancos_headers_nomina.json')) as f:
