...
with open(pkg_resources.resource_filename(__name__, 'conversor_nominas_bancos_chile/bancos_codigos.json')) as f:
...
with open(pkg_resources.resource_filename(__name__,'conversor_nominas_bancos_chile/bancos_headers_nomina.json') as f:
