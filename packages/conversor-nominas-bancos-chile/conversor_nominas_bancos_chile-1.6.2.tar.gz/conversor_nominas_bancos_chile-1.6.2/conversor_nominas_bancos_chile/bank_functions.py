...
bancos_codigos = pkg_resources.resource_filename(__name__, 'bancos_codigos.json')
bancos_codigos = json.loads(bancos_codigos.read())
...
dict_encabezados_nominas_banco = pkg_resources.resource_filename(__name__, 'bancos_headers_nomina.json')
dict_encabezados_nominas_banco = json.loads(dict_encabezados_nominas_banco.read())
