...
print(pkg_resources.resource_filename(__name__, 'bancos_codigos.json'))

with open(pkg_resources.resource_filename(__name__, 'bancos_codigos.json')) as f:
...
with open(pkg_resources.resource_filename(__name__,'bancos_headers_nomina.json')) as f:
