...
bancos_codigos = pkg_resources.resource_string(__name__, 'bancos_codigos.json')
...
dict_encabezados_nominas_banco = pkg_resources.resource_string(__name__, 'bancos_headers_nomina.json')
