...
from gm.api._utils import (
    ...
    param_convert_iter_to_str, param_convert_date,
    param_convert_iter_to_list,
)
...
def get_fundamentals(table, symbols, start_date, end_date,
    ...
    # type: (str, str|List, str|Datetime, str|Datetime, str|List, str, str, int, bool) -> List[Dict]|pd.DataFrame
    """
    查询基本面财务数据
    """
...
def get_fundamentals_n(table, symbols, end_date,
    ...
    # type: (str, str|List, str|Datetime, str, str, str, int, bool) -> List[Dict]|pd.DataFrame
    """
...
def get_history_instruments(symbols, fields=None, start_date=None, end_date=None, df=False):
    # type: (str|List, str|List, str|Datetime, str|Datetime, bool) -> List[Dict]|pd.DataFrame
    """
...
def get_history_constituents(index, start_date=None, end_date=None):
    # type: (str, str|Datetime, str|Datetime) -> List[Dict]
    """
    查询指数历史成分股
    返回的list每项是个字典,包含的key值有:
...
def get_trading_dates(exchange, start_date, end_date):
    # type: (str, str|Datetime, str|Datetime) -> List[str]
    """
    查询交易日列表
...
def get_dividend(symbol, start_date, end_date=None, df=False):
    # type: (str, str|Datetime, str|Datetime, bool) -> List[Dict]|pd.DataFrame
    """
    查询分红送配
    """
    start_date = param_convert_date(start_date)
...
def history(symbol, frequency, start_time, end_time, fields=None,
    ...
    # type: (str|List, str, str|Datetime, str|Datetime, str, bool, str, int, str, bool) -> List[Dict]|pd.DataFrame
    """
    查询历史行情
    """
    symbol = param_convert_iter_to_str(symbol)
    start_time = param_convert_date(start_time)
    end_time = param_convert_date(end_time)
    adjust_end_time = param_convert_date(adjust_end_time)
    fields = param_convert_iter_to_str(fields)
...
def history_n(symbol, frequency, count, end_time=None, fields=None,
              skip_suspended=True, fill_missing=None, adjust=None,
              adjust_end_time='', df=False):
    # type: (str, str, int, str|Datetime, str|List, bool, str, int, str, bool) -> List[Dict]|pd.DataFrame
    """
    查询历史行情
    """
    symbol = symbol.strip()
...
def option_get_symbols_by_exchange(exchange=None, trade_date=None, call_or_put="", adjust_flag=""):
    ...
    trade_date = param_convert_date(trade_date)
