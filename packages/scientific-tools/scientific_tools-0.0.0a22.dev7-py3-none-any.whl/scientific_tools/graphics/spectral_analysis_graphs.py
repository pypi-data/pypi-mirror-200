...
title: str= "Spectrum of the signal", xlabel: str="Frequencies (in Hz)", ylabel: str="Amplitudes", color="blue", **kwargs) :
    ...
    """
    frequencies = spectral_analysis.DFT_frequencies(function, f, fs, anti_aliasing, args_before_t, args_after_t, **kwargs)
    amplitudes = spectral_analysis.DFT_amplitudes(function, f, fs, anti_aliasing, args_before_t, args_after_t, **kwargs)
...
def plot_phases_spectrum(function, f: float, fs: float,
...
title: str= "Spectrum of the signal", xlabel: str="Frequencies (in Hz)", ylabel: str="Phases", color="blue", **kwargs) :
    ...
    """
    frequencies = spectral_analysis.DFT_frequencies(function, f, fs, anti_aliasing, args_before_t, args_after_t, **kwargs)
    phases = spectral_analysis.DFT_phases(function, f, fs, anti_aliasing, unit, args_before_t, args_after_t, **kwargs)
