...
# -*- coding: utf-8 -*-
#
# speechwidgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'speechwidgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'speechwidgetsdoc'
...
latex_documents = [
    (master_doc, 'speechwidgets.tex', 'speechwidgets Documentation',
     'nicolvisser', 'manual'),
]
