...
class Layout:
    ...
    def plot_legend(self, ax_z, subaxs):
        """
        plot legend(s)
        ...
        if self._legend.visible:
            ax_z.legend(loc=locations[self._legend.position][0],
                        ncol=self._legend.columns,
                        labelcolor=self._legend.font_color,
                        prop={'size': self._legend.font_size,
                              'style': self._legend.font_style,
                              'weight': self._legend.font_weight},
                        frameon=self._legend.frame,
                        framealpha=self._legend.opacity,
                        bbox_to_anchor=locations[self._legend.position][1])
            
        for i in range(len(subaxs)):
            try:
                subaxs[i].get_legend().remove()
            except:
                pass

            if self._sublayouts[i].legend.visible:
                subaxs[i].legend(loc=locations[self._sublayouts[i].legend.position][0],
                                ncol=self._sublayouts[i].legend.columns,
                                labelcolor=self._sublayouts[i].legend.font_color,
                                prop={'size': self._sublayouts[i].legend.font_size,
                                      'style': self._sublayouts[i].legend.font_style,
                                      'weight': self._sublayouts[i].legend.font_weight},
                                frameon=self._sublayouts[i].legend.frame,
                                framealpha=self._sublayouts[i].legend.opacity,
                                bbox_to_anchor=locations[self._sublayouts[i].legend.position][1])
