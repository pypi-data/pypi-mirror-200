...
class UserWalletTransferTransactionModel(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description"], typing_extensions.Literal["reference"], typing_extensions.Literal["amount"], typing_extensions.Literal["fromAccountId"], typing_extensions.Literal["toAccountId"], typing_extensions.Literal["currencyCode"], typing_extensions.Literal["toAmount"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description"], typing_extensions.Literal["reference"], typing_extensions.Literal["amount"], typing_extensions.Literal["fromAccountId"], typing_extensions.Literal["toAccountId"], typing_extensions.Literal["currencyCode"], typing_extensions.Literal["toAmount"], ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        toAmount: typing.Union[MetaOapg.properties.toAmount, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
