...
class UserBankDepositTransactionModel(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description"], typing_extensions.Literal["reference"], typing_extensions.Literal["amount"], typing_extensions.Literal["accountId"], typing_extensions.Literal["bankId"], typing_extensions.Literal["currencyCode"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description"], typing_extensions.Literal["reference"], typing_extensions.Literal["amount"], typing_extensions.Literal["accountId"], typing_extensions.Literal["bankId"], typing_extensions.Literal["currencyCode"], ]):
