...
from testmon_dev.process_code import blob_to_checksums, checksums_to_blob

# #if TYPES
from testmon_dev.common import TestExecutions
...
class CachedProperty:
    ...
    Source: https://github.com/bottlepy/bottle/commit/fa7733e075da0d790d809aa3d2f53071897e6f76  # noqa: E501
    """
...
def check_fingerprint_db(
    files_methods_checksums, record: ChangedFileData
...
class DB:  # pylint: disable=too-many-public-methods
    ...
    def fetch_or_create_file_fp(
        self, filename, checksum, method_checksums
