...
class Rest(object):
    ...
    def soul(self, rest: 'Rest'):
        ...
        """
        self.only_body, self.check_status, self.encoding, self.server_name, self.server_list, self.host, self.description = rest.only_body, rest.check_status, rest.encoding, rest.server_name, rest.server_list, self.host, self.description
