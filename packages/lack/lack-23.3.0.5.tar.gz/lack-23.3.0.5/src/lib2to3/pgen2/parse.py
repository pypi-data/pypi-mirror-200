...
from lib2to3.pytree import convert, NL, Context, RawNode, Leaf, Node

if TYPE_CHECKING:
    from lib2to3.pgen2.driver import TokenProxy
...
class Parser(object):
    ...
    def __init__(self, grammar: Grammar, convert: Optional[Convert] = None) -> None:
        ...
        **post-note: the convert argument is ignored since for Black's
        usage, convert will always be lib2to3.pytree.convert. Allowing
