...
class Enum(object):
    ...
    _interop_func.restype = c_void_p
    _interop_func.argtypes = [c_void_p, c_void_p, c_void_p]
    def ToString2(self, format: str, provider: c_void_p) -> str:
        """
        Parameters
        ----------
        ...
        result = InteropUtils.invoke("enum_tostring2", self._pointer, format_ptr, provider)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    ...
    _interop_func.restype = c_void_p
    _interop_func.argtypes = [c_void_p, c_void_p]
    def ToString3(self, format: str) -> str:
        """
        Parameters
        ----------
        ...
        result = InteropUtils.invoke("enum_tostring3", self._pointer, format_ptr)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
    ...
    _interop_func.restype = c_void_p
    _interop_func.argtypes = [c_void_p, c_void_p]
    def ToString4(self, provider: c_void_p) -> str:
        """
        Parameters
        ----------
        ...
        str:
            Underlying .Net type is string
        """
        result = InteropUtils.invoke("enum_tostring4", self._pointer, provider)
        result = c_void_p(result) if result is not None else None
        result_str = InteropUtils.uptr_to_utf8(result)
        return result_str
