...
class DTTNotifyPlugin(CorePluginMixin, notify.NotificationPlugin):
    ...
    def _post(self, group, project):
        ...
        payload = f"{payload} #### level: {group.level} \n\n"
        payload = f"{payload} #### url: {group.url} \n\n"
        payload = f"{payload} #### culprit: {group.culprit} \n\n"
        payload = f"{payload} #### environment: {group.event.environment} \n\n"
        payload = f"{payload} #### release: {group.event.release} \n\n"
        payload = f"{payload} #### timestamp: {group.event.timestamp} \n\n"
