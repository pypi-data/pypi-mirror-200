...
!$omp declare variant (mkl_lapack_csteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,d,e,z,work)
...
!$omp declare variant (mkl_lapack_dsteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,d,e,z,work)
...
!$omp declare variant (mkl_lapack_ssteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,d,e,z,work)
...
!$omp declare variant (mkl_lapack_zsteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,d,e,z,work)
...
!$omp declare variant (dgels_batch_strided:mkl_lapack_dgels_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
      ...
      subroutine mkl_lapack_cgels_batch_strided_omp_offload_ilp64() bind(c) 
      ...
      complex*8, intent(inout) :: b(stride_b,*)
      integer, intent(out) :: info(*)
!$omp declare variant (cgels_batch_strided:mkl_lapack_cgels_batch_strided_omp_offload_ilp64) match(construct={target variant dispatch}, device={arch(gen)})
!$omp declare variant (cgels_batch_strided:mkl_lapack_cgels_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
      end subroutine cgels_batch_strided

      subroutine mkl_lapack_zgels_batch_strided_omp_offload_ilp64() bind(c)
      ...
      complex*16, intent(inout) :: b(stride_b,*)
      integer, intent(out) :: info(*)
!$omp declare variant (zgels_batch_strided:mkl_lapack_zgels_batch_strided_omp_offload_ilp64) match(construct={target variant dispatch}, device={arch(gen)})
!$omp declare variant (zgels_batch_strided:mkl_lapack_zgels_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
