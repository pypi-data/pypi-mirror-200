...
def sub_size(n_train, subsample_share_mult, max_share):
    ...
    subsam_share *= subsample_share_mult
...
def controls_into_dic(
        ...
        m_share_min, m_grid, m_random_poisson, alpha_reg_min,
        alpha_reg_max, alpha_reg_grid,
        random_thresholds, knn_min_k, share_forest_sample, descriptive_stats,
        m_share_max, max_cats_z_vars, variable_importance_oob,
        ...
        _weight_as_sparse, mp_type_weights, mp_weights_tree_batch,
    ...
    controls_dict = {
        ...
        'm_share_min': m_share_min, 'm_grid': m_grid,
        ...
        'desc_stat': descriptive_stats, 'm_share_max': m_share_max,
        ...
        'show_plots': show_plots, '_weight_as_sparse': _weight_as_sparse,
