...
class ArticleEndpoint(Endpoint):
    ...
    def put(self, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Create a new article. Required parameters for the creation of this entity are "title", "templateType" and "world".
        ...
        :param content:     Metadata of the new article with at least he required fields.
        :return:            Metadata of the created article with the id.
        """
    ...
    def patch(self, identifier: str, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        {
            "authornotes":"This is the first draft of this article.",
            "prompt":{
                "id":"{{promptId}}"
            }
        }

        :param identifier:  The id of the article to be updated.
        :param content:     All the fields that should be updated.
        :return:            Metadata of the article.
        """
    ...
    def delete(self, identifier: str):
        ...
        :param identifier:  The id of the article to be deleted.
        """
