...
from pywaclient.endpoints.manuscript_beats import ManuscriptBeatEndpoint


class ManuscriptPartEndpoint(Endpoint):

    def __init__(self, client: 'AragornApiClient'):
        super().__init__(client)
        self._path = 'manuscript_part'
        self.beat = ManuscriptBeatEndpoint(client)
        self._path_beats = 'manuscript_beats'
    ...
    def beats(self, identifier: str) -> Iterable[Dict[str, Any]]:
        ...
        """
        return self._scroll_collection(self._path_beats, {'id': identifier}, 'entities')
