...
class NoteEndpoint(Endpoint):
    ...
    def get(self, identifier: str, granularity: int) -> Dict[str, Any]:
        """Get the metadata of a specific note.

        :param identifier:  The identifier of the note.
    ...
    def put(self, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Create a new note. Required parameters for the creation of this entity is "title", "content" and "notesection.id".

        :param content:     Metadata of the new note with at least he required fields.
        :return:            Metadata of the created note with the id.
        """
        return self._put_request(self.path, content)

    def patch(self, identifier: str, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Update (patch) the content of a note.

        :param identifier:  The id of the note to be updated.
        :param content:     All the fields that should be updated.
        :return:            Metadata of the note.
        """
    ...
    def delete(self, identifier: str):
        ...
        :param identifier:  The id of the note to be deleted.
        """
