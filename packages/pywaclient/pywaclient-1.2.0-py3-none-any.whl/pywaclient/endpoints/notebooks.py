...
class NotebookEndpoint(Endpoint):

    def __init__(self, client: 'AragornApiClient'):
        super().__init__(client)
        self.path = 'notebook'
        self.list_path = 'notebook/notesections'

    def get(self, identifier: str, granularity: int) -> Dict[str, Any]:
        """Get the metadata of a specific notebook.

        :param identifier:  The identifier of the notebook.
    ...
    def put(self, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Create a new notebook. Required parameters for the creation of this entity is "title".

        :param content:     Metadata of the new notebook with at least he required fields.
        :return:            Metadata of the created notebook with the id.
        """
        return self._put_request(self.path, content)

    def patch(self, identifier: str, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Update (patch) the content of a notebook.

        :param identifier:  The id of the notebook to be updated.
        :param content:     All the fields that should be updated.
        :return:            Metadata of the notebook.
        """
    ...
    def delete(self, identifier: str):
        ...
        :param identifier:  The id of the notebook to be deleted.
        """
    ...
    def note_sections(self, notebook_id: str, complete: bool = True, limit: int = 50, offset: int = 0) -> Iterable[Dict[str, Any]]:
        ...
        """
        if complete:
            return self._scroll_collection(self.list_path, {'id': notebook_id}, 'entities')
        assert offset >= 0
        assert 1 <= limit <= 50
        return self._post_request(self.list_path, {'id': notebook_id}, {'limit': limit, 'offset': offset})['entities']