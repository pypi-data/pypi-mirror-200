...
class ChronicleEndpoint(Endpoint):
    ...
    def get(self, identifier: str, granularity: int) -> Dict[str, Any]:
        """Get the metadata of a specific chronicle.

        :param identifier:  The identifier of the chronicle.
    ...
    def put(self, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Create a new chronicle. Required parameters for the creation of this entity are "title", "templateType" and "world".
        ...
        :param content:     Metadata of the new chronicle with at least he required fields.
        :return:            Metadata of the created chronicle with the id.
        """
        return self._put_request(self.path, content)

    def patch(self, identifier: str, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Update (patch) the content of an chronicle.

        {
            "authornotes":"This is the first draft of this chronicle.",
            "prompt":{
                "id":"{{promptId}}"
            }
        }

        :param identifier:  The id of the chronicle to be updated.
        :param content:     All the fields that should be updated.
        :return:            Metadata of the chronicle.
        """
    ...
    def delete(self, identifier: str):
        ...
        :param identifier:  The id of the chronicle to be deleted.
        """
