...
class CanvasEndpoint(Endpoint):
    ...
    def get(self, identifier: str, granularity: int) -> Dict[str, Any]:
        """Get the metadata of a specific canvas.
    ...
    def put(self, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Create a new canvas. Required parameters for the creation of this entity are "title", "templateType" and "world".
        ...
        :param content:     Metadata of the new canvas with at least he required fields.
        :return:            Metadata of the created canvas with the id.
        """
        return self._put_request(self.path, content)

    def patch(self, identifier: str, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Update (patch) the content of an canvas.

        {
            "authornotes":"This is the first draft of this canvas.",
            "prompt":{
                "id":"{{promptId}}"
            }
        }

        :param identifier:  The id of the canvas to be updated.
        :param content:     All the fields that should be updated.
        :return:            Metadata of the canvas.
        """
    ...
    def delete(self, identifier: str):
        ...
        :param identifier:  The id of the canvas to be deleted.
        """
