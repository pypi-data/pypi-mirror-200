...
def _add_package_if_not_exists_conda(conda_env, package_to_check, package_to_add):
    ...
    for i, dep in enumerate(pip_dependencies):
        if isinstance(dep, dict) and "pip" in dep and isinstance(dep["pip"], list):
            for item in dep["pip"]:
                if package_to_check in item:
                    return conda_env
            conda_env["dependencies"][i]["pip"].append(package_to_add)
            return conda_env
    return conda_env


def _add_package_if_not_exists_pip(pip_list, package_to_check, package_to_add):
    """
    ...
    for item in pip_list:
        if package_to_check in item:
            return pip_list
    pip_list.append(package_to_add)
    return pip_list
...
def save_model(
    ...
    conda_env = _add_package_if_not_exists_conda(conda_env, package_to_check="azureml_metrics",
                                     package_to_add=constants.AdditionalPackages.METRICS_PACKAGE)
    conda_env = _add_package_if_not_exists_conda(conda_env, package_to_check="azureml_evaluate_mlflow",
                                     package_to_add=constants.AdditionalPackages.EVALUATE_PACKAGE)
    pip_requirements = _add_package_if_not_exists_pip(pip_requirements, package_to_check="azureml_metrics",
                                     package_to_add=constants.AdditionalPackages.METRICS_PACKAGE)
    pip_requirements = _add_package_if_not_exists_pip(pip_requirements, package_to_check="azureml_evaluate_mlflow",
                                     package_to_add=constants.AdditionalPackages.EVALUATE_PACKAGE)
