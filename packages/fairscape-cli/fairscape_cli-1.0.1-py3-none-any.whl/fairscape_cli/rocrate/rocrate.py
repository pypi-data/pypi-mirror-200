...
def generate_id(rocrate_id: str, name: str, metadata_type: str)-> str: 
    """
    Given ROCrate metadata generate an id for the 
    """

    return f"{rocrate_id}/{name}-{metadata_type}"
...
def create(
    ...
    #if guid == None:
    #    guid = f"ark:/{organization_guid}/{project_guid}/{name.replace(' ', '_')}"
