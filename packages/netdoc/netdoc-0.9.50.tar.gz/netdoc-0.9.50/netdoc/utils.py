...
# from netdoc.schemas import credential, discoverable, discoverylog
...
# def import_log(path):
#     """Import log from path."""
#     credential = credential.get_or_create(name="test")

#     for dirpath, dirnames, filenames in walk(path):
#         for filename in filenames:
#             if filename.endswith(".json"):
#                 filepath = f"{dirpath}/{filename}"
#                 address = filepath.split("-")[0]
...
#         discoverable_qs = models.Discoverable.objects.filter(
...
#         schemas.discoverylog.create(discoverable_id=discoverable_o.id, **discoverablelog_json)
