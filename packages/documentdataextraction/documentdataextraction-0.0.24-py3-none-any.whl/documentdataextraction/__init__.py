...
class DataExtractor:
    ...
    def get(self):
        ...
        try:
            ...
            if '.doc' in file_path or '.DOC' in file_path or '.docx' in file_path or '.DOCX' in file_path:
                dot_ind = filename.rindex('.')
                only_name = filename[:dot_ind]
                output_file_name = self.file_storage_path + "/" + only_name + ".txt"
                doc = aw.Document(file_path)

                doc.save(self.file_storage_path+'/'+output_file_name)
