...
class ImageAugmentation():
    def __init__(self,height:int=640) -> None:
    ...
    def image_rotate(self,image:np.array,polygons:Polygon,rotation_angle:int=12) -> Tuple[Polygon,np.array]:
        ...
        try:
            aug = iaa.Sequential([iaa.Rotate((-rotation_angle,rotation_angle),fit_output=True),
                                iaa.Resize({"height": self.height, "width": "keep-aspect-ratio"})])
    ...
    def image_affine(self,image:np.array,polygons:Polygon,scale_range:range=(0.5,1.2)) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_perspective_transform(self,image:np.array,polygons:Polygon,scale_range:range=(0.01,0.2)) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_noise(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_blur(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    #chnag thissssssss
    def image_hue(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_brightness(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_change_colorTemperature(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_removeSaturation(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_contrast(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_upFlip(self,image:np.array,polygons:Polygon,flip_percentage:float=1.0) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_shear(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
            choice = random.choice([0,1])
            if choice == 0:
    ...
    def image_rotate90(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
            choice = random.choice([0,1])
            if choice == 0:
    ...
    # beta mode
    def image_weatherChange(self,image:np.array,polygons:Polygon,rain_speed:range=(0.1,0.3)) -> Tuple[Polygon,np.array]:
        try:
    ...
    def image_cutOut(self,image:np.array,polygons:Polygon,number_of_square:int=2,size:float=0.1) -> Tuple[Polygon,np.array]:
        try:
    ...
    def blur_and_noise(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
            aug = iaa.Sequential([iaa.GaussianBlur(sigma=(0.8, 2.5)),
                                iaa.Resize({"height": self.height, "width": "keep-aspect-ratio"}),
    ...
    def mixed_aug_1(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def mixed_aug_2(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
    ...
    def mixed_aug_3(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
            choice = random.choice([0,1])
            if choice == 0:
    ...
    def mixed_aug_4(self,image:np.array,polygons:Polygon) -> Tuple[Polygon,np.array]:
        try:
