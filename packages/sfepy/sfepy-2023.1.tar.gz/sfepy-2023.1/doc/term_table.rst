...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb <multi_physics-biot_npbc>`
   * - ev_biot_stress
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`bio <multi_physics-biot>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`
   ...
   * - dw_div_grad
     ...
     - :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto <navier_stokes-stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`
   * - dw_dot
     ...
     - :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`wel <quantum-well>`, :ref:`aco <acoustics-acoustics>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`bal <large_deformation-balloon>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`hyd <quantum-hydrogen>`, :ref:`bor <quantum-boron>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`osc <quantum-oscillator>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`aco <acoustics-acoustics>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`poi.neu <diffusion-poisson_neumann>`
   * - ev_integrate
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`wel <quantum-well>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`aco <acoustics-acoustics>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`hyd <quantum-hydrogen>`, :ref:`poi <diffusion-poisson>`, :ref:`bor <quantum-boron>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`osc <quantum-oscillator>`, :ref:`sin <diffusion-sinbc>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`cub <diffusion-cube>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`sei.loa <linear_elasticity-seismic_load>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`bio <multi_physics-biot>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`
   * - dw_lin_elastic_iso
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`she.can <linear_elasticity-shell10x_cantilever>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`its.1 <linear_elasticity-its2D_1>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto <navier_stokes-stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`
   * - dw_stokes_wave
   ...
   * - dw_surface_ltr
     ...
     - :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`
   * - ev_surface_moment
   ...
   * - dw_volume_lvf
     ...
     - .. math::
           ...
           \int_{\Omega} f q
     - :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`bur.2D <dg-burgers_2D>`
   * - ev_volume_surface
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`act.fib <large_deformation-active_fibres>`, :ref:`hyp <large_deformation-hyperelastic>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`bal <large_deformation-balloon>`, :ref:`per.tl <large_deformation-perfusion_tl>`
   * - dw_tl_he_ogden
