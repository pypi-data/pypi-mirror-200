...
class generatedClass(ZIDS_Postprocessor):
    ...
    def __init__(self, artifacts: generatedProjectNameSharedArtifacts=None, callback=None) -> None:
        ...
        super().__init__(artifacts, callback)
    ...
    def get_output_object(self, predictable):
        ...
        #     self.callback(generatedProjectNameOutputs(pred=pred, prob=prob))
