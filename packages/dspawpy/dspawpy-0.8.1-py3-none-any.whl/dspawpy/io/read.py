...
def json2structures(jsonfile):
    ...
    Examples
    --------
    >>> from pymatgen.io.read import json2structures
    ...
    for step in range(len(j)):
        ...
        pymatgen_structures.append(Structure(lattice, elements, coords, coords_are_cartesian=True))
