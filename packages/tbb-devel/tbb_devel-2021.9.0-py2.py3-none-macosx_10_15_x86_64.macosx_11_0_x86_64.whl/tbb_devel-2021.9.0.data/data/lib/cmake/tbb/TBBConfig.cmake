...
foreach (_tbb_component ${TBB_FIND_COMPONENTS})
    ...
    get_filename_component(_tbb_release_lib "${_tbb_root}/lib/${_tbb_subdir}/lib${_tbb_component}${_bin_version}.${_${_tbb_component}_bin_version}.dylib" ABSOLUTE)

    if (NOT TBB_FIND_RELEASE_ONLY)
        get_filename_component(_tbb_debug_lib "${_tbb_root}/lib/${_tbb_subdir}/lib${_tbb_component}${_bin_version}_debug.${_${_tbb_component}_bin_version}.dylib" ABSOLUTE)
    endif()
