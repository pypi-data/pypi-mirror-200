...
class Script(ApiDto):
    ...
    def copy(self, myfunction):
        ...
        for param_name in myfunction.__code__.co_varnames:
            param_type = None
            if param_name in myfunction.__annotations__:
                param_type = myfunction.__annotations__[param_name]
            self.function.params[param_name] = str(param_type)
