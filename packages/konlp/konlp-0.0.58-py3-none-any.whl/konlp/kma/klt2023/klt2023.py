...
class klt2023:
    def __init__(self):
        ...
        jarpath = os.sep.join([konlp.__path__[0], 'kma', 'klt2023', 'lib', 'klt2023.jar'])
        ...
        self.proc = subprocess.Popen(['java', '-jar', jarpath, dicpath], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
