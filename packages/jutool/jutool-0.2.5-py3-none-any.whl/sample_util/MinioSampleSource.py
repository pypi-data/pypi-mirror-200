...
mss = MinioSampleSource("/Users/jiangke/Downloads/buffer2", "kehome.cn:31001", "datareader", "uo6HuW37ArEYu9",
                        "samplestore")

# 获得该数据源的所有数据集
# all_set = mss.get_remote_dir_list()
# 打印该数据源的报表(详细的markdown文档)
mss.print_markdown_arrange_dir_list(mss.get_remote_dir_list(), "/Users/jiangke/minigpt/local_data2.md")
