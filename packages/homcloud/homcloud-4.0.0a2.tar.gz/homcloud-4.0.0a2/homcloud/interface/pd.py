...
class PDList(object):
    ...
    @staticmethod
    def compute_pd(filtration, save_to, parallels, algorithm,
                   save_suppl_info):
    ...
    def from_alpha_filtration(pointcloud, weight=False, no_squared=None, *,
        ...
        return PDList.compute_pd(filtration, save_to, parallels,
    ...
    @staticmethod
    def from_simplicial_levelset(simplicial_function, vertex_symbols=None,
                                 algorithm=None, save_to=None,
        ...
        """
        filtration = simplicial_levelset.SimplicialFiltration(
            simplicial_function, vertex_symbols, save_boundary_map
        )
