...
class WriteHeaderFooterClass():
    ...
    def header_footer(self, fig, page_number, term):
        ...
        fig.add_artist(lines.Line2D([0, 1], [0.94, 0.94], color=REPORT_MAIN_COLOR, linewidth=80, zorder=0))
        ...
        # Footer
        fig.add_artist(lines.Line2D([0, 1], [0.0004, 0.0004], color=REPORT_MAIN_COLOR, linewidth=80, zorder=0))
...
def write_header_and_footer(waf_log_time, figs):
    """
    ...
    for fig in (figs):
        ...
        write.header_footer(fig, page_number, term)
