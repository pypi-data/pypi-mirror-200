...
def write_front_cover(fig):
    """
    Write cover of report
    """
    fig.add_artist(lines.Line2D([0, 1], [0.24, 0.24], color=REPORT_MAIN_COLOR, linewidth=306, zorder=0))
    ...
    fig.text(0.42, 0.36, empowerd, color="#ffffff", fontsize=24)
