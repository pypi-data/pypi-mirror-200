...
class EnrollRecordServices:
    ...
    def record_list(params, need_pagination=True):
        ...
        filter_filed_list = list(filed_map.values()) + [
            "thread_id_list", "id", "enroll_id", "enroll_id_list", "user_id", "enroll_auth_status_id", "enroll_pay_status_id",
    ...
    def complex_record_list(params):
        ...
        reversal_filed_map.update({"thread_id_list": "enroll__thread_id__in"})
