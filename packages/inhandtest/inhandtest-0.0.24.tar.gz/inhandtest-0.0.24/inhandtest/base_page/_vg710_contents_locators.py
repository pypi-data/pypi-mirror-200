        ...
        return {
            ...
            'administration_system_time': {
                ...
                'ntp_server': {
                    ...
                    'wait_locator': [self.frame.locator('#cancel-button')]}},
            ...
            'administration_alarm': {
                ...
                'status': {
                    ...
                    'wait_locator': [self.frame.locator('#clear-all')]},
                'alarm_input': {
            ...
            'vpn_certificate_management': {
                ...
                'root_ca': {
                    ...
                    'wait_locator': [self.frame.locator('#ca-import-button')]}},
            ...
            'wizards_new_ipsec_tunnel': {
                ...
                'new_ipsec_tunnel': {
                    ...
                    'visible_locator': [self.frame.locator('#cancel-button')],
                    'wait_locator': [self.frame.locator('#cancel-button')]}},
            'wizards_ipsec_expert_config': {
                ...
                'ipsec_expert_config': {
                    ...
                    'visible_locator': [self.frame.locator('#refresh-button')],
                    'wait_locator': [self.frame.locator('#refresh-button')]}},
