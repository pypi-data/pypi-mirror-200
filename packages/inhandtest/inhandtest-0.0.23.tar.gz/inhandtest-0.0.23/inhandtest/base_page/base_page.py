        ...
        def access(menu_one: str, locators: dict):
            ...
            if not visible:
                ...
                if locators.get(menu_one).get('wait_locator'):
                    ...
                    self.page.wait_for_timeout(1000)  # 多等500ms
...
if __name__ == '__main__':
    ...
    with sync_playwright() as playwright:
        ...
        my_base.access_menu('network_wi_fi.status')
        user_table = Table(
            [('mode', 'input'), ('status', 'input'), ('ssid', 'input'), ('channel', 'input'), ('mac', 'input'),
             ('auth', 'input'), ('encry', 'input'), ('network', 'input')],
            my_base.page.frame_locator('#window_content').locator('#wifi-2g-grid'),
            ['mode', 'status', 'ssid', 'channel', 'mac', 'auth', 'encry', 'network'], None)
