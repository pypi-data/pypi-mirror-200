...
def Statistics(Calculated, Targeted):
    ...
    for j in range(0,numevar):
        ...
        print('')
        print ('Biggest absolute point difference, variable ' + str(j+1) +' = ' + str(np.max(abs(erroari))) + ' ')
        print('------------------------')
...
#Plot two variables differences in a sequential series
...
#Plot two variables diferenças in a sequential series
