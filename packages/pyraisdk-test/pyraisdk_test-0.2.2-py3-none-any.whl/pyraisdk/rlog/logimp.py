...
class _AsyncEventLoggerBackendLoop:
    def __init__(
        ...
        self.categories_q: List[queue.Queue[Event]] = [unstruct_queue, struct_queue]
    ...
    def run_q(self, q: queue.Queue, sinks: List[EventSink]):
    ...
    def run_q_inner(self, q: queue.Queue, sinks: List[EventSink]):
