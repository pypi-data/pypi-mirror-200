...
class TypedValue(betterproto.Message):
    ...
    # complete specification. [Experimental]
...
class Decimal64(betterproto.Message):
    ...
    digits following the decimal point in the digit set. This message is
    deprecated in favor of encoding all floating point types as double
    precision.
    """
...
class SubscribeRequest(betterproto.Message):
    ...
    SubscriptionList to initiate a subscription. Reference: gNMI Specification
    Section 3.5.1.1
    """
