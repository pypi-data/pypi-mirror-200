...
class StudyFieldLattice(UniformGrid):
    ...
    def __init__(self, workspace = None, *args, **kwargs):
        ...
        if workspace is None:
            ...
            print('\033[35mThe workspace is not specified, the temFile.vtk will be stored in the current working directory: ' + self._workspace+'\033[0m')
        else:
    ...
    def read_CsvData(self, filePath, skiorows = 1, add2DC = True):
        # This function is used to read the csv data.
        # Parameters:
        #   filePath: the path of the csv file.
        #   skiorows: the number of rows to skip at the beginning of the file.
