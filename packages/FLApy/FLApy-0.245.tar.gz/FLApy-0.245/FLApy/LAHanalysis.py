...
class LAH_calculator(object):
    ...
    def hotspotAnalysis(self, CPU_count = None):
        ...
        gi_star_valuesSet = Parallel(n_jobs=numCPU, verbose=50)(delayed(self.cal_Gix)(argLAH) for argLAH in obsIDX)
    ...
    def cal_Gix(self, obsIdx):
        ...
        GIXdistances = np.where(GIXdistances == 0, 1e-6, GIXdistances)
