...
class LAH_calculator(object):
    ...
    def __init__(self, inGrid = None, fieldName = 'SVF_flat', interpolation = None, externalData = False):
        ...
        if inGrid is None:
        ...
        elif inGrid is not None and os.path.isfile(inGrid) is True:
            ...
            self.tempSFL = str(self._inGrid.field_data['temPath'])
    ...
    def interpolation_3D(self, inGrid, fieldName = None, resolutionGrid = 1, externalData = False):
        ...
        tensorGrid.add_field_data([str(inGrid.field_data['temPath'])], 'temPath')
    ...
    def calculate_spatial_weights_matrix_idw(self, coords):
        ...
        distances, indices = kdtree.query(coords, k=n_points, workers=os.cpu_count()-1)
