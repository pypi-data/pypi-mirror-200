...
class LAcalculator():
    ...
    def __init__(self, inDataContainer = None, lensMapRadius = 500, pointSizeRange = (0.5, 7)):
        ...
        if inDataContainer is None:
            ...
            self.tempSFL = str(self._DataContainer.field_data['temPath'])
