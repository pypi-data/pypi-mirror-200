...
def add_checkpoint_callback_policy(args_param, callback, rank_id, saving_steps):
    r"""
    ...
    if args_param.save_checkpoint:
        ...
        ckpt_config = CheckpointConfig(save_checkpoint_steps=saving_steps, #args_param.save_checkpoint_steps,
        ...
        ckpt_save_obs_cb = CheckpointSaveCallback(local_ckpt_dir=save_dir_rank,
                                                  ...
                                                  syn_obs_steps=saving_steps,  #args_param.save_checkpoint_steps
                                                  )
...
def main(opt):
    ...
    saving_steps = int(actual_epoch_num // 2)
    ...
    add_checkpoint_callback_policy(args_opt, callback, rank_id, saving_steps)
