...
bike_horn=GagButton(snd_frame,image=bike_horn_img,gag=rustygag.Gag("Gag","Bike Horn","Sound",0,4))
whistle_img=PhotoImage(file=asset_path+'/assets/img/whistle.png')
whistle=GagButton(snd_frame,image=whistle_img,gag=rustygag.Gag("Gag","Whistle","Sound",1,7))
bugle_img=PhotoImage(file=asset_path+'/assets/img/bugle.png')
bugle=GagButton(snd_frame,image=bugle_img,gag=rustygag.Gag("Gag","Bugle","Sound",2,11))
aoogah_img=PhotoImage(file=asset_path+'/assets/img/aoogah.png')
aoogah=GagButton(snd_frame,image=aoogah_img,gag=rustygag.Gag("Gag","Aoogah","Sound",3,16))
elephant_trunk_img=PhotoImage(file=asset_path+'/assets/img/elephant-trunk.png')
elephant_trunk=GagButton(snd_frame,image=elephant_trunk_img,gag=rustygag.Gag("Gag","Elephant Trunk","Sound",4,21))
fog_horn_img=PhotoImage(file=asset_path+'/assets/img/fog-horn.png')
fog_horn=GagButton(snd_frame,image=fog_horn_img,gag=rustygag.Gag("Gag","Fog Horn","Sound",5,50))
opera_singer_img=PhotoImage(file=asset_path+'/assets/img/opera-singer.png')
opera_singer=GagButton(snd_frame,image=opera_singer_img,gag=rustygag.Gag("Gag","Opera Singer","Sound",6,90))
#Throw
trw_frame=Frame(gag_frame)
cupcake_img=PhotoImage(file=asset_path+'/assets/img/cupcake.png')
cupcake=GagButton(trw_frame,image=cupcake_img,gag=rustygag.Gag("Gag","Cupcake","Throw",0,6))
fruit_pie_slice_img=PhotoImage(file=asset_path+'/assets/img/fruit-pie-slice.png')
fruit_pie_slice=GagButton(trw_frame,image=fruit_pie_slice_img,gag=rustygag.Gag("Gag","Fruit Pie Slice","Throw",1,10))
cream_pie_slice_img=PhotoImage(file=asset_path+'/assets/img/cream-pie-slice.png')
cream_pie_slice=GagButton(trw_frame,image=cream_pie_slice_img,gag=rustygag.Gag("Gag","Cream Pie Slice","Throw",2,17))
whole_fruit_pie_img=PhotoImage(file=asset_path+'/assets/img/whole-fruit-pie.png')
whole_fruit_pie=GagButton(trw_frame,image=whole_fruit_pie_img,gag=rustygag.Gag("Gag","Whole Fruit Pie","Throw",3,27))
whole_cream_pie=GagButton(trw_frame,image=whole_cream_pie_img,gag=rustygag.Gag("Gag","Whole Cream Pie","Throw",4,40))
birthday_cake_img=PhotoImage(file=asset_path+'/assets/img/birthday-cake.png')
birthday_cake=GagButton(trw_frame,image=birthday_cake_img,gag=rustygag.Gag("Gag","Birthday Cake","Throw",5,100))
wedding_cake_img=PhotoImage(file=asset_path+'/assets/img/wedding-cake.png')
wedding_cake=GagButton(trw_frame,image=wedding_cake_img,gag=rustygag.Gag("Gag","Wedding Cake","Throw",6,120))
#Squirt
sqt_frame=Frame(gag_frame)
squirting_flower_img=PhotoImage(file=asset_path+'/assets/img/squirting-flower.png')
squirting_flower=GagButton(sqt_frame,image=squirting_flower_img,gag=rustygag.Gag("Gag","Squirting Flower","Squirt",0,4))
water_glass_img=PhotoImage(file=asset_path+'/assets/img/glass-of-water.png')
water_glass=GagButton(sqt_frame,image=water_glass_img,gag=rustygag.Gag("Gag","Glass of Water","Squirt",1,8))
squirt_gun_img=PhotoImage(file=asset_path+'/assets/img/squirt-gun.png')
squirt_gun=GagButton(sqt_frame,image=squirt_gun_img,gag=rustygag.Gag("Gag","Squirt Gun","Squirt",2,12))
seltzer_bottle_img=PhotoImage(file=asset_path+'/assets/img/seltzer-bottle.png')
seltzer_bottle=GagButton(sqt_frame,image=seltzer_bottle_img,gag=rustygag.Gag("Gag","Seltzer Bottle","Squirt",3,21))
fire_hose_img=PhotoImage(file=asset_path+'/assets/img/fire-hose.png')
fire_hose=GagButton(sqt_frame,image=fire_hose_img,gag=rustygag.Gag("Gag","Fire Hose","Squirt",4,30))
storm_cloud_img=PhotoImage(file=asset_path+'/assets/img/storm-cloud.png')
storm_cloud=GagButton(sqt_frame,image=storm_cloud_img,gag=rustygag.Gag("Gag","Storm Cloud","Squirt",5,80))
geyser_img=PhotoImage(file=asset_path+'/assets/img/geyser.png')
geyser=GagButton(sqt_frame,image=geyser_img,gag=rustygag.Gag("Gag","Geyser","Squirt",6,105))
#Drop
drp_frame=Frame(gag_frame)
flower_pot_img=PhotoImage(file=asset_path+'/assets/img/flower-pot.png')
flower_pot=GagButton(drp_frame,image=flower_pot_img,gag=rustygag.Gag("Gag","Flower Pot","Drop",0,10))
sandbag_img=PhotoImage(file=asset_path+'/assets/img/sandbag.png')
sandbag=GagButton(drp_frame,image=sandbag_img,gag=rustygag.Gag("Gag","Sandbag","Drop",1,18))
anvil_img=PhotoImage(file=asset_path+'/assets/img/anvil.png')
anvil=GagButton(drp_frame,image=anvil_img,gag=rustygag.Gag("Gag","Anvil","Drop",2,30))
big_weight_img=PhotoImage(file=asset_path+'/assets/img/big-weight.png')
big_weight=GagButton(drp_frame,image=big_weight_img,gag=rustygag.Gag("Gag","Big Weight","Drop",3,45))
safe_img=PhotoImage(file=asset_path+'/assets/img/safe.png')
safe=GagButton(drp_frame,image=safe_img,gag=rustygag.Gag("Gag","Safe","Drop",4,70))
grand_piano_img=PhotoImage(file=asset_path+'/assets/img/grand-piano.png')
grand_piano=GagButton(drp_frame,image=grand_piano_img,gag=rustygag.Gag("Gag","Grand Piano","Drop",5,170))
toontanic_img=PhotoImage(file=asset_path+'/assets/img/toontanic.png')
toontanic=GagButton(drp_frame,image=toontanic_img,gag=rustygag.Gag("Gag","Toontanic","Drop",6,180))
#Trap!
trpFrame=Frame(gag_frame)
banana_peel_img=PhotoImage(file=asset_path+'/assets/img/banana-peel.png')
banana_peel=GagButton(trpFrame,image=banana_peel_img,gag=rustygag.Gag("Gag","Banana Peel","Trap",0,12))
rake_img=PhotoImage(file=asset_path+'/assets/img/rake.png')
rake=GagButton(trpFrame,image=rake_img,gag=rustygag.Gag("Gag","Rake","Trap",1,18))
marbles_img=PhotoImage(file=asset_path+'/assets/img/marbles.png')
marbles=GagButton(trpFrame,image=marbles_img,gag=rustygag.Gag("Gag","Marbles","Trap",2,35))
quicksand_img=PhotoImage(file=asset_path+'/assets/img/quicksand.png')
quicksand=GagButton(trpFrame,image=quicksand_img,gag=rustygag.Gag("Gag","Quicksand","Trap",3,50))
trapdoor_img=PhotoImage(file=asset_path+'/assets/img/trapdoor.png')
trapdoor=GagButton(trpFrame,image=trapdoor_img,gag=rustygag.Gag("Gag","Trapdoor","Trap",4,85))
tnt_img=PhotoImage(file=asset_path+'/assets/img/tnt.png')
tnt=GagButton(trpFrame,image=tnt_img,gag=rustygag.Gag("Gag","TNT","Trap",5,180))
railroad_img=PhotoImage(file=asset_path+'/assets/img/railroad.png')
railroad=GagButton(trpFrame,image=railroad_img,gag=rustygag.Gag("Gag","Railroad","Trap",6,200))
...
def organic_toggle(*arg):
  data = rustygag.orgswap(organic.get())
  organic.set(data[0])
