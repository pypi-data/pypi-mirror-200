...
class view(object):
    ...
    '''
    def __init__(self,width=640,height=480,q="",pdb="",para="",command="",v=""):
        '''Create a iCn3D view.
...
""" % (jsfile,css1file,css2file,warnid)
        ...
        self.startjs += 'cfg = {divid: "%s", pdb: "%s", %swidth: "%spx", height: "%spx", mobilemenu: 1, notebook: 1, command: \'%s\', %s};\n' % (divid, pdb, inputid, width, height, command, para)
