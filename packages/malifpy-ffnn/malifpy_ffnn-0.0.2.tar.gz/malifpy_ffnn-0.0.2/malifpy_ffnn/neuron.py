...
import malifpy_ffnn.synapse
import malifpy_ffnn.layer
...
class Neuron:
    def __init__(self) -> None:
        ...
        self.synapse_in  : List[malifpy_ffnn.synapse.Synapse] = []
        self.synapse_out : List[malifpy_ffnn.synapse.Synapse] = []
        self.layer : malifpy_ffnn.layer.Layer
    ...
    def connect_from(self, neuron_arg: Neuron) -> None:
        ...
        """
        new_synapse : malifpy_ffnn.synapse.Synapse = malifpy_ffnn.synapse.Synapse(neuron_arg, self)
        self.add_synapse_in(new_synapse)
        neuron_arg.add_synapse_out(new_synapse)

    def add_synapse_in(self, s: malifpy_ffnn.synapse.Synapse) -> None:
        """
        Memasukkan malifpy_ffnn.synapse.Synapse ke synapse_in
        """
    ...
    def add_synapse_out(self, s: malifpy_ffnn.synapse.Synapse) -> None:
        """
        Memasukkan malifpy_ffnn.synapse.Synapse ke synapse_out
        """
