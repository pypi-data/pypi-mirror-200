...
class DOTMarginalsAnalyzer(MarginalsAnalyzerBase):
    ...
    def _compute_noise_matrix_averaged(self,
        ...
        if not qrem_math.is_matrix_stochastic(noise_matrix_averaged):
            ...
            # if anf.query_yes_no("Do you wish to print that matrix?"):
            ...
            if self.__fill_missing_columns:
            ...
            elif anf.query_yes_no("Do you wish to assume that missing columns are ideal?\n"
                ...
                if anf.query_yes_no("Do you wish to fill all missing columns in the future?\n"
