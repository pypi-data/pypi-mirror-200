...
class PyMedQuery:
    ...
    def __init__(self) -> NoReturn:
        self.crud: Any = CRUD(user=config.USER,
    ...
    def _check_version(self) -> NoReturn:
        """_check_version is a method that checks the version of the client against the latest version on PyPI
