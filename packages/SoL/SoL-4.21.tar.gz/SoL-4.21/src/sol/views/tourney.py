        ...
        if tboards:
            for i in range(1, tboards+1):
                fields.append(dict(
                    ...
                    label=t(_('M1/$game', mapping=dict(game=i))),
                    hint=t(_('Number of unsuccessful shots of the first competitor in game'
                             ' $game.', mapping=dict(game=i))),
                    min=0,
                    width=50,
                    sortable=False,
                    name=f'coins1_{i}'))
            for i in range(1, tboards+1):
                fields.append(dict(
                    ...
                    # in given game" in the Matches grid, keep it as compact as possible
                    label=t(_('M2/$game', mapping=dict(game=i))),
                    hint=t(_('Number of unsuccessful shots of the second competitor in game'
                             ' $game.', mapping=dict(game=i))),
                    min=0,
                    width=50,
                    sortable=False,
            ...
            for i in range(1, 20):
                fields.append(dict(
                    ...
                    # given game" in the Matches grid, keep it as compact as possible
                    label=t(_('C1/$game', mapping=dict(game=i))),
                    hint=t(_('Number of coins of the first competitor in game'
                             ' $game.', mapping=dict(game=i))),
                    min=0,
                    max=9,
                    width=50,
            ...
            for i in range(1, 20):
                fields.append(dict(
                    ...
                    # in given game" in the Matches grid, keep it as compact as possible
                    label=t(_('C2/$game', mapping=dict(game=i))),
                    hint=t(_('Number of coins of the second competitor in game'
                             ' $game.', mapping=dict(game=i))),
                    min=0,
                    max=9,
                    width=50,
            ...
            for i in range(1, 20):
                fields.append(dict(
                    ...
                    # in given game" in the Matches grid, keep it as compact as possible
                    label=t(_('Q/$game', mapping=dict(game=i))),
                    hint=t(_('Which competitor pocketed the Queen in game $game, if any.',
                             mapping=dict(game=i))),
                    width=50,
                    sortable=False,
                    hidden=True,
...
def countdown(request):
    ...
    curruser = request.session.get('user_id', '*nouser*')
    if tourney.countdownstarted is None:
        elapsed = None
    else:
        elapsed = int(time.time() * 1000) - tourney.countdownstarted
        if elapsed > tourney.duration * 60 * 1000:  # pragma: no cover
            elapsed = None
    return dict(
        _=t,
        ngettext=ngettext,
