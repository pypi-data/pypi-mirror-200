    ...
    while True:
        ...
        if coins1 > 0 and coins2 > 0:
            ...
            return {'success': False,
                    'message': translate(_('Cannot accept both coins in game $game!',
        ...
        if queen is not None:
            if queen not in ('1', '2'):  # pragma: no cover
                doom()
                return {'success': False,
                        'message': translate(_('Bad value for Queen in game $game!',
                                               mapping=dict(game=game)))}

        if not 0 <= coins1 < 10:
            doom()
            return {'success': False,
                    'message': translate(_('Out of range value for coins 1 in game'
                                           ' $game!', mapping=dict(game=game)))}

        if not 0 <= coins2 < 10:
            doom()
            return {'success': False,
                    'message': translate(_('Out of range value for coins 2 in game'
                                           ' $game!', mapping=dict(game=game)))}
