...
from jsonwebtoken.algorithms import Algorithm, has_crypto
from jsonwebtoken.api_jws import PyJWS
...
class TestJWS:
    ...
    def test_encode_with_typ(self, jws):
        ...
        """
        token = jws.encode(
            payload.encode("utf-8"), "secret", headers={"typ": "secevent+jsonwebtoken"}
        )
