...
import jsonwebtoken
from jsonwebtoken import PyJWKClient
from jsonwebtoken.api_jwk import PyJWK
from jsonwebtoken.exceptions import PyJWKClientError
...
class TestPyJWKClient:
    ...
    def test_get_signing_key_from_jsonwebtoken(self):
        ...
        with mocked_success_response(RESPONSE_DATA_WITH_MATCHING_KID):
            jwks_client = PyJWKClient(url)
            signing_key = jwks_client.get_signing_key_from_jsonwebtoken(token)

        data = jsonwebtoken.decode(
            token,
            signing_key.key,
            algorithms=["RS256"],
    ...
    def test_get_jsonwebtoken_set_cache_expired_result(self):
        url = "https://dev-87evx9ru.auth0.com/.well-known/jwks.json"
    ...
    def test_get_jsonwebtoken_set_cache_disabled(self):
        url = "https://dev-87evx9ru.auth0.com/.well-known/jwks.json"
    ...
    def test_get_jsonwebtoken_set_failed_request_should_clear_cache(self):
        url = "https://dev-87evx9ru.auth0.com/.well-known/jwks.json"
    ...
    def test_get_jsonwebtoken_set_refresh_cache(self):
        url = "https://dev-87evx9ru.auth0.com/.well-known/jwks.json"
        jwks_client = PyJWKClient(url)
    ...
    def test_get_jsonwebtoken_set_no_matching_kid_after_second_attempt(self):
        url = "https://dev-87evx9ru.auth0.com/.well-known/jwks.json"
        jwks_client = PyJWKClient(url)
    ...
    def test_get_jsonwebtoken_set_invalid_lifespan(self):
        url = "https://dev-87evx9ru.auth0.com/.well-known/jwks.json"
