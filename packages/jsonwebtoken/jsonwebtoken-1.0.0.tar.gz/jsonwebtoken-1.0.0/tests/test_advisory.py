...
class TestAdvisory:
    ...
    def test_ghsa_ffqj_6fqr_9h24(self):
        ...
        # Making a good jsonwebtoken token that should work by signing it
        # with the private key
        # encoded_good = jsonwebtoken.encode({"test": 1234}, priv_key_bytes, algorithm="EdDSA")
        ...
        # Both of the jsonwebtoken tokens are validated as valid
        jsonwebtoken.decode(
            encoded_good,
            pub_key_bytes,
            algorithms=jsonwebtoken.algorithms.get_default_algorithms(),
        )
        ...
        # HMAC specifies illegal strings for the HMAC secret in jsonwebtoken/algorithms.py
        #
        #        invalid_str ings = [
        #            b"-----BEGIN PUBLIC KEY-----",
        #            b"-----BEGIN CERTIFICATE-----",
        ...
        #        ]
        #
        # However, OKPAlgorithm (ed25519) accepts the following in  jsonwebtoken/algorithms.py:
        #
        ...
        # Making a good jsonwebtoken token that should work by signing it with the private key
        # encoded_good = jsonwebtoken.encode({"test": 1234}, ssh_priv_key_bytes, algorithm="ES256")
        ...
        # encoded_bad = jsonwebtoken.encode({"test": 1234}, ssh_key_bytes, algorithm="HS256")
